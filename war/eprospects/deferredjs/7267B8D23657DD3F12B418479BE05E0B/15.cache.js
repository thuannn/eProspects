...
defineSeed(789, 235, {}, BrancheNameAfterChangeEvent_0);
...
defineSeed(849, 722, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheListPresenter, Q$FrmBrancheListUiHandler]), FrmBrancheListPresenter_0);
...
defineSeed(850, 662, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$1_0);
...
defineSeed(851, 662, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$2_0);
...
defineSeed(852, 662, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$3_0);
...
;
defineSeed(853, 754, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(856, 736, {}, FrmBrancheListPresenterMyProxyImpl$2_0);
...
defineSeed(857, 1, {}, FrmBrancheListPresenterMyProxyImpl$2$1_0);
...
defineSeed(1368, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1467, 727, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1468, 380, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
...
defineSeed(1469, 1, {}, FrmBrancheListView$2_0);
...
defineSeed(1470, 380, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
...
defineSeed(1471, 1, {}, FrmBrancheListView$4_0);
...
defineSeed(1472, 380, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
...
defineSeed(1473, 1, {}, FrmBrancheListView$6_0);
...
defineSeed(1474, 1, {}, FrmBrancheListView_BinderImpl_0);
...
defineSeed(1475, 1, {}, FrmBrancheListView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1854, 666, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
...
defineSeed(1861, 666, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0);
...
var Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter', 849), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter$1', 850), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter$2', 851), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter$3', 852), Lcom_lemania_eprospects_client_event_BrancheNameAfterChangeEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'BrancheNameAfterChangeEvent', 789), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2', 856), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2$1', 857), Lcom_lemania_eprospects_client_view_FrmBrancheListView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView', 1467), Lcom_lemania_eprospects_client_view_FrmBrancheListView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$1', 1468), Lcom_lemania_eprospects_client_view_FrmBrancheListView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$2', 1469), Lcom_lemania_eprospects_client_view_FrmBrancheListView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$3', 1470), Lcom_lemania_eprospects_client_view_FrmBrancheListView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$4', 1471), Lcom_lemania_eprospects_client_view_FrmBrancheListView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$5', 1472), Lcom_lemania_eprospects_client_view_FrmBrancheListView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$6', 1473), Lcom_lemania_eprospects_client_view_FrmBrancheListView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView_BinderImpl', 1474), Lcom_lemania_eprospects_client_view_FrmBrancheListView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView_BinderImpl$Widgets', 1475), Lcom_lemania_eprospects_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$5X', 1854), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X', 1861);
$entry(onLoad)(15);
