...
defineSeed(246, 237, {}, FocusEvent_0);
...
defineSeed(249, 248, {}, KeyPressEvent_0);
...
defineSeed(509, 510, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), PasswordTextBox_0);
...
function $authenticateUser(this$static, userName, password){
  ...
  if ($equals_5(userName, 'thuannn@gmail.com') && $equals_5(password, 'Suisse2011-')) {
    ...
    $fire($listAll_7(rc), new HomePresenter$1_0(this$static, userName, password));
  }
}
...
defineSeed(1004, 713, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(1005, 653, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(1006, 653, makeCastMap([Q$Receiver]), HomePresenter$2_0);
_.onFailure_0 = function onFailure_92(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_92(response){
  $onSuccess_88(this, dynamicCast(response, Q$UserProxy));
}
;
_.this$0 = null;
...
defineSeed(1647, 718, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1648, 1, {}, HomeView_BinderImpl_0);
...
defineSeed(1649, 1, {}, HomeView_HomeViewUiBinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1650, 1, makeCastMap([Q$KeyPressHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$1_0);
_.this$1 = null;
function HomeView_HomeViewUiBinderImpl$Widgets$2_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1651, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$2_0);
...
defineSeed(1652, 1, makeCastMap([Q$FocusHandler, Q$EventHandler, Q$HomeView_HomeViewUiBinderImpl$Widgets$3]), HomeView_HomeViewUiBinderImpl$Widgets$3_0);
_.this$1 = null;
...
defineSeed(1974, 657, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
...
_.val$password = null;
_.val$userName = null;
var Lcom_lemania_eprospects_client_presenter_HomePresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'HomePresenter', 1004), Lcom_lemania_eprospects_client_presenter_HomePresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'HomePresenter$1', 1005), Lcom_lemania_eprospects_client_presenter_HomePresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'HomePresenter$2', 1006), Lcom_lemania_eprospects_client_view_HomeView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'HomeView', 1647), Lcom_lemania_eprospects_client_view_HomeView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'HomeView_BinderImpl', 1648), Lcom_lemania_eprospects_client_view_HomeView_1HomeViewUiBinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets', 1649), Lcom_lemania_eprospects_client_view_HomeView_1HomeViewUiBinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets$1', 1650), Lcom_lemania_eprospects_client_view_HomeView_1HomeViewUiBinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets$2', 1651), Lcom_lemania_eprospects_client_view_HomeView_1HomeViewUiBinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets$3', 1652), Lcom_google_gwt_user_client_ui_PasswordTextBox_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'PasswordTextBox', 509), Lcom_google_gwt_event_dom_client_KeyPressEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'KeyPressEvent', 249), Lcom_google_gwt_event_dom_client_FocusEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'FocusEvent', 246), Lcom_lemania_eprospects_shared_service_UserRequestFactory_1UserRequestContextImpl$1X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'UserRequestFactory_UserRequestContextImpl$1X', 1974);
$entry(onLoad)(28);
