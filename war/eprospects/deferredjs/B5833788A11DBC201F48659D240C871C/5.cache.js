...
defineSeed(295, 287, {}, DateTimeFormatInfoImpl_0);
...
defineSeed(296, 1, makeCastMap([Q$DateTimeFormat]), DateTimeFormat_0);
_.pattern = null;
var cache = null;
...
defineSeed(297, 1, makeCastMap([Q$DateTimeFormat$PatternPart]), DateTimeFormat$PatternPart_0);
_.abutStart = false;
_.count = 0;
_.text_0 = null;
...
defineSeed(299, 1, makeCastMap([Q$Serializable, Q$Comparable, Q$Date]), Date_1, Date_2);
...
defineSeed(298, 299, makeCastMap([Q$Serializable, Q$Comparable, Q$Date]), DateRecord_0);
...
defineSeed(680, 299, makeCastMap([Q$Poser, Q$DatePoser, Q$Serializable, Q$Comparable, Q$Date]));
...
defineSeed(776, 238, {}, ApplicationStep2CompletedEvent_0);
...
function $calculatePrice(this$static, programmesCode, courseCode, txtJulyWeek, txtAugustWeek, optConfortPlusPrivate, optConfortPrivate, optStandardPrivate, optConfortPlusShare, optConfortShare, optStandardShare){
  if ($equals_5(programmesCode, ($clinit_SummerCampSettingValues() , 'SUMMERCOURSE'))) {
    if ($equals_5(courseCode, 'LANGUE')) {
      $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard', ($clinit_Double() , new Double_0(item_summercourse20_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
      $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs', new Double_0(item_summercourse25_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
    }
    if ($equals_5(courseCode, 'LANGUECONVERSATION')) {
      $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard & 5 cours de conversation', ($clinit_Double() , new Double_0(item_summercourse205_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
      $equals_5(txtAugustWeek, '') || $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs & 10 cours de conversation', new Double_0(item_summercourse2510_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
    }
  }
  if ($equals_5(programmesCode, 'SUMMERCAMP')) {
    ...
    if ($equals_5(courseCode, 'LANGUE')) {
      if (optConfortPlusPrivate) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard - Chambre Confort+ priv\xE9e', ($clinit_Double() , new Double_0(item_summercourse20_confortplus_private_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs - Chambre Confort+ priv\xE9e', new Double_0(item_summercourse25_confortplus_private_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optConfortPrivate) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard - Chambre Confort priv\xE9e', ($clinit_Double() , new Double_0(item_summercourse20_confort_private_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs - Chambre Confort priv\xE9e', new Double_0(item_summercourse25_confort_private_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optStandardPrivate) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard - Chambre Standard priv\xE9e', ($clinit_Double() , new Double_0(item_summercourse20_standard_private_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs - Chambre Standard priv\xE9e', new Double_0(item_summercourse25_standard_private_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optConfortPlusShare) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard - Chambre Confort+ partag\xE9e', ($clinit_Double() , new Double_0(item_summercourse20_confortplus_share_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs - Chambre Confort+ partag\xE9e', new Double_0(item_summercourse25_confortplus_share_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optConfortShare) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard - Chambre Confort partag\xE9e', ($clinit_Double() , new Double_0(item_summercourse20_confort_share_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs - Chambre Confort partag\xE9e', new Double_0(item_summercourse25_confort_share_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optStandardShare) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard - Chambre Standard partag\xE9e', ($clinit_Double() , new Double_0(item_summercourse20_standard_share_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs - Chambre Standard partag\xE9e', new Double_0(item_summercourse25_standard_share_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
    }
    if ($equals_5(courseCode, 'LANGUECONVERSATION')) {
      if (optConfortPlusPrivate) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard & 5 cours de conversation - Chambre Confort+ priv\xE9e', ($clinit_Double() , new Double_0(item_summercourse205_confortplus_private_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs & 10 cours de conversation - Chambre Confort+ priv\xE9e', new Double_0(item_summercourse2510_confortplus_private_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optConfortPrivate) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard & 5 cours de conversation - Chambre Confort priv\xE9e', ($clinit_Double() , new Double_0(item_summercourse205_confort_private_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs & 10 cours de conversation - Chambre Confort priv\xE9e', new Double_0(item_summercourse2510_confort_private_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optStandardPrivate) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard & 5 cours de conversation - Chambre Standard priv\xE9e', ($clinit_Double() , new Double_0(item_summercourse205_standard_private_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs & 10 cours de conversation - Chambre Standard priv\xE9e', new Double_0(item_summercourse2510_standard_private_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optConfortPlusShare) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard & 5 cours de conversation - Chambre Confort+ partag\xE9e', ($clinit_Double() , new Double_0(item_summercourse205_confortplus_share_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs & 10 cours de conversation - Chambre Confort+ partag\xE9e', new Double_0(item_summercourse2510_confortplus_share_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optConfortShare) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard & 5 cours de conversation - Chambre Confort partag\xE9e', ($clinit_Double() , new Double_0(item_summercourse205_confort_share_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs & 10 cours de conversation - Chambre Confort partag\xE9e', new Double_0(item_summercourse2510_confort_share_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
      if (optStandardShare) {
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD002', 'Cours de langue standard & 5 cours de conversation - Chambre Standard partag\xE9e', ($clinit_Double() , new Double_0(item_summercourse205_standard_share_amount.value_0 * __parseAndValidateInt(txtJulyWeek))))), null);
        $doFire(this$static.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0('CD003', 'Cours de langue intensifs & 10 cours de conversation - Chambre Standard partag\xE9e', new Double_0(item_summercourse2510_standard_share_amount.value_0 * __parseAndValidateInt(txtAugustWeek)))), null);
      }
    }
  }
}
...
function $formCompleted_0(programmesCode, courseCode, startDate, optConfortPlusPrivate, optConfortPrivate, optStandardPrivate, optConfortPlusShare, optConfortShare, optStandardShare, optKeyDepositCHF, optKeyDepositEuro, optKeyDepositUSD){
  if ($equals_5(programmesCode, '')) {
    alert_0(($clinit_NotificationTypes() , 'Donn\xE9e invalide : ') + ' Programme');
    return false;
  }
  if ($equals_5(courseCode, '')) {
    alert_0(($clinit_NotificationTypes() , 'Donn\xE9e invalide : ') + ' Combination du cours');
    return false;
  }
  if ($equals_5(startDate, '')) {
    alert_0(($clinit_NotificationTypes() , 'Donn\xE9e invalide : ') + ' Date de d\xE9but');
    return false;
  }
  if ($equals_5(programmesCode, ($clinit_SummerCampSettingValues() , 'SUMMERCAMP'))) {
    if (!optConfortPlusPrivate && !optConfortPrivate && !optStandardPrivate && !optConfortPlusShare && !optConfortShare && !optStandardShare) {
      alert_0(($clinit_NotificationTypes() , 'Donn\xE9e invalide : ') + ' Merci de choisir un choix de chambre.');
      return false;
    }
    if (!optKeyDepositCHF && !optKeyDepositEuro && !optKeyDepositUSD) {
      alert_0(($clinit_NotificationTypes() , 'Donn\xE9e invalide : ') + ' Merci de choisir un choix de la monnaie du d\xE9p\xF4t.');
      return false;
    }
  }
  return true;
...
function $nextStep_1(this$static, chkApplicaitonFee, chkPackAssurance, programmesCode, courseCode, startDate, weekNumber, txtJulyWeek, txtAugustWeek, chkContinueAfter, optConfortPlusPrivate, optConfortPrivate, optStandardPrivate, optConfortPlusShare, optConfortShare, optStandardShare, optKeyDepositCHF, optKeyDepositEuro, optKeyDepositUSD){
  var rc, rf;
  if (!$formCompleted_0(programmesCode, courseCode, startDate, optConfortPlusPrivate, optConfortPrivate, optStandardPrivate, optConfortPlusShare, optConfortShare, optStandardShare, optKeyDepositCHF, optKeyDepositEuro, optKeyDepositUSD))
    return;
...
defineSeed(1189, 713, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationItemSavedEvent$ApplicationItemSavedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ApplicationStep2Presenter, Q$ApplicationStep2UiHandlers]), ApplicationStep2Presenter_0);
...
_.onReset = function onReset_31(){
  ...
  $doFire(this.eventBus, new ApplicationItemSelectedEvent_0(new ApplicationItem_0(($clinit_SummerCampSettingValues() , 'CD001'), "Frais d'inscription", item_applicationfee_amount)), null);
}
;
_.curUser = null;
_.placeManager = null;
...
defineSeed(1190, 653, makeCastMap([Q$Receiver]), ApplicationStep2Presenter$1_0);
...
defineSeed(1191, 653, makeCastMap([Q$Receiver]), ApplicationStep2Presenter$2_0);
...
function $onChkPackAssuranceClick(this$static){
  ...
  $setOnLeaveConfirmation(dynamicCast(dynamicCast(this$static.uiHandlers, Q$ApplicationStep2UiHandlers), Q$ApplicationStep2Presenter).placeManager, ($clinit_NotificationTypes() , 'Merci de cliquer sur Enregistrer pour sauvegarder les informations modifi\xE9es.'));
}
...
function $onLstStartDateChange(this$static, event_0){
  ...
  !event_0 || $setOnLeaveConfirmation(dynamicCast(dynamicCast(this$static.uiHandlers, Q$ApplicationStep2UiHandlers), Q$ApplicationStep2Presenter).placeManager, ($clinit_NotificationTypes() , 'Merci de cliquer sur Enregistrer pour sauvegarder les informations modifi\xE9es.'));
}
...
function $showApplicationDetails_1(this$static, app){
  ...
  $setText_1(this$static.lblApplicationInfo, app.getEmailAddress() + ' - ' + app.getApplicationID());
  $setValue_0(this$static.chkApplicaitonFee, ($clinit_Boolean() , app.isChkApplicationFee()?TRUE_1:FALSE_1));
...
defineSeed(1199, 718, makeCastMap([Q$IsWidget, Q$ApplicationStep2Presenter$MyView]), ApplicationStep2View_0);
...
defineSeed(1200, 1, {}, ApplicationStep2View_BinderImpl_0);
function $build_main_3(this$static){
  var main, f_VerticalPanel1, f_Label2, f_HorizontalPanel3, lblApplicationInfo, f_Label4, f_FlowPanel5, f_HorizontalPanel6, f_VerticalPanel43, f_VerticalPanel7, f_Label8, f_Label9, chkApplicaitonFee, chkPackAssurance, f_Label10, f_Label11, f_Label12, f_Grid13, f_Label14, lstProgrammes, f_Label15, lstCourses, chkContinueAfter, f_Label28, f_Label29, f_Grid30, f_Label31, optConfortPlusPrivate, optConfortPrivate, optStandardPrivate, f_Label32, optConfortPlusShare, optConfortShare, optStandardShare, f_Label33, f_Label34, f_Label35, f_Label36, f_Grid37, f_Label38, optKeyDepositCHF, optKeyDepositEuro, optKeyDepositUSD, f_VerticalPanel39, f_Label40, tblItems, f_HorizontalPanel41, f_Label42, lblTotalAmount, f_HorizontalPanel44, cmdPreviousStep, sb, cmdNextStep, sb_0;
  main = new SimplePanel_0;
  $add_4(main, (f_VerticalPanel1 = new VerticalPanel_0 , $setHorizontalAlignment_1(f_VerticalPanel1, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $add_11(f_VerticalPanel1, (f_Label2 = new Label_0 , f_Label2.element['className'] = 'pageTitle' , $setTextOrHtml(f_Label2.directionalTextHelper, 'CHOIX DU PROGRAMME', false) , $updateHorizontalAlignment(f_Label2) , f_Label2)) , $add_11(f_VerticalPanel1, (f_HorizontalPanel3 = new HorizontalPanel_0 , $add_9(f_HorizontalPanel3, (lblApplicationInfo = new Label_0 , $setTextOrHtml(lblApplicationInfo.directionalTextHelper, "L'inscription ID :", false) , $updateHorizontalAlignment(lblApplicationInfo) , this$static.owner.lblApplicationInfo = lblApplicationInfo , lblApplicationInfo)) , $add_9(f_HorizontalPanel3, (f_Label4 = new Label_0 , $setAutoHorizontalAlignment(f_Label4, ALIGN_RIGHT) , $setTextOrHtml(f_Label4.directionalTextHelper, 'Step 2 of 5', false) , $updateHorizontalAlignment(f_Label4) , f_Label4)) , f_HorizontalPanel3.element.style['width'] = '100%' , f_HorizontalPanel3.table['cellSpacing'] = 5 , f_HorizontalPanel3)) , $add_11(f_VerticalPanel1, (f_FlowPanel5 = new FlowPanel_0 , $add_7(f_FlowPanel5, (f_HorizontalPanel6 = new HorizontalPanel_0 , $add_9(f_HorizontalPanel6, (f_VerticalPanel7 = new VerticalPanel_0 , $add_11(f_VerticalPanel7, (f_Label8 = new Label_0 , f_Label8.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label8.directionalTextHelper, 'INSCRIPTION', false) , $updateHorizontalAlignment(f_Label8) , f_Label8)) , $add_11(f_VerticalPanel7, (f_Label9 = new Label_0 , f_Label9.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label9.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label9) , f_Label9)) , $add_11(f_VerticalPanel7, (chkApplicaitonFee = new CheckBox_0 , chkApplicaitonFee.inputElem.disabled = true , $setStyleName_0(chkApplicaitonFee, getStylePrimaryName(chkApplicaitonFee.element) + '-disabled') , $setTextOrHtml(chkApplicaitonFee.directionalTextHelper, "Frais d'inscription, CHF 100.-", false) , $setValue_0(chkApplicaitonFee, ($clinit_Boolean() , $clinit_Boolean() , TRUE_1)) , this$static.owner.chkApplicaitonFee = chkApplicaitonFee , chkApplicaitonFee)) , $add_11(f_VerticalPanel7, (chkPackAssurance = new CheckBox_0 , $setTextOrHtml(chkPackAssurance.directionalTextHelper, 'Pack Assurance sant\xE9 CHF 190.- (obligatoire pour les internes sauf les r\xE9sidents en Suisse)', false) , $addDomHandler(chkPackAssurance, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames13, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , this$static.owner.chkPackAssurance = chkPackAssurance , chkPackAssurance)) , $add_11(f_VerticalPanel7, (f_Label10 = new Label_0 , f_Label10.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label10.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label10) , f_Label10)) , $add_11(f_VerticalPanel7, (f_Label11 = new Label_0 , f_Label11.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label11.directionalTextHelper, 'PROGRAMMES', false) , $updateHorizontalAlignment(f_Label11) , f_Label11)) , $add_11(f_VerticalPanel7, (f_Label12 = new Label_0 , f_Label12.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label12.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label12) , f_Label12)) , $add_11(f_VerticalPanel7, (f_Grid13 = new Grid_0 , $resizeColumns(f_Grid13, 2) , $resizeRows(f_Grid13, 2) , $setWidget_1(f_Grid13, 0, 0, (f_Label14 = new Label_0 , $setTextOrHtml(f_Label14.directionalTextHelper, 'Programme', false) , $updateHorizontalAlignment(f_Label14) , f_Label14)) , $setWidget_1(f_Grid13, 0, 1, (lstProgrammes = new ListBox_0 , $addDomHandler(lstProgrammes, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames5, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstProgrammes = lstProgrammes , lstProgrammes)) , $setWidget_1(f_Grid13, 1, 0, (f_Label15 = new Label_0 , $setTextOrHtml(f_Label15.directionalTextHelper, 'Combination du cours', false) , $updateHorizontalAlignment(f_Label15) , f_Label15)) , $setWidget_1(f_Grid13, 1, 1, (lstCourses = new ListBox_0 , $addDomHandler(lstCourses, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames6, TYPE) , this$static.owner.lstCourses = lstCourses , lstCourses)) , f_Grid13.element.style['width'] = '100%' , f_Grid13)) , $add_11(f_VerticalPanel7, this$static.f_Grid16) , $setCellVerticalAlignment(f_VerticalPanel7, this$static.f_Grid16, ($clinit_HasVerticalAlignment() , ALIGN_MIDDLE)) , $add_11(f_VerticalPanel7, (chkContinueAfter = new CheckBox_0 , $setTextOrHtml(chkContinueAfter.directionalTextHelper, "Je souhaite continuer le programme choisi apr\xE8s le cours d'\xE9t\xE9.", false) , $addDomHandler(chkContinueAfter, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames14, TYPE_0) , this$static.owner.chkContinueAfter = chkContinueAfter , chkContinueAfter)) , $add_11(f_VerticalPanel7, (f_Label28 = new Label_0 , f_Label28.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label28.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label28) , f_Label28)) , $add_11(f_VerticalPanel7, (f_Label29 = new Label_0 , f_Label29.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label29.directionalTextHelper, 'Logement - Internat', false) , $updateHorizontalAlignment(f_Label29) , f_Label29)) , $add_11(f_VerticalPanel7, (f_Grid30 = new Grid_0 , $resizeColumns(f_Grid30, 4) , $resizeRows(f_Grid30, 2) , $setWidget_1(f_Grid30, 0, 0, (f_Label31 = new Label_0 , $setTextOrHtml(f_Label31.directionalTextHelper, 'Chambre priv\xE9e', false) , $updateHorizontalAlignment(f_Label31) , f_Label31)) , $setWidget_1(f_Grid30, 0, 1, (optConfortPlusPrivate = new RadioButton_0('new name') , $setTextOrHtml(optConfortPlusPrivate.directionalTextHelper, 'Confort plus', false) , $addDomHandler(optConfortPlusPrivate, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames7, TYPE_0) , this$static.owner.optConfortPlusPrivate = optConfortPlusPrivate , optConfortPlusPrivate)) , $setWidget_1(f_Grid30, 0, 2, (optConfortPrivate = new RadioButton_0('new name') , $setTextOrHtml(optConfortPrivate.directionalTextHelper, 'Confort', false) , $addDomHandler(optConfortPrivate, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames8, TYPE_0) , this$static.owner.optConfortPrivate = optConfortPrivate , optConfortPrivate)) , $setWidget_1(f_Grid30, 0, 3, (optStandardPrivate = new RadioButton_0('new name') , $setTextOrHtml(optStandardPrivate.directionalTextHelper, 'Standard', false) , $addDomHandler(optStandardPrivate, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames9, TYPE_0) , this$static.owner.optStandardPrivate = optStandardPrivate , optStandardPrivate)) , $setWidget_1(f_Grid30, 1, 0, (f_Label32 = new Label_0 , $setTextOrHtml(f_Label32.directionalTextHelper, 'Chambre \xE0 partager (Deux lits jumeaux)', false) , $updateHorizontalAlignment(f_Label32) , f_Label32)) , $setWidget_1(f_Grid30, 1, 1, (optConfortPlusShare = new RadioButton_0('new name') , $setTextOrHtml(optConfortPlusShare.directionalTextHelper, 'Confort plus', false) , $addDomHandler(optConfortPlusShare, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames10, TYPE_0) , this$static.owner.optConfortPlusShare = optConfortPlusShare , optConfortPlusShare)) , $setWidget_1(f_Grid30, 1, 2, (optConfortShare = new RadioButton_0('new name') , $setTextOrHtml(optConfortShare.directionalTextHelper, 'Confort', false) , $addDomHandler(optConfortShare, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames11, TYPE_0) , this$static.owner.optConfortShare = optConfortShare , optConfortShare)) , $setWidget_1(f_Grid30, 1, 3, (optStandardShare = new RadioButton_0('new name') , $setTextOrHtml(optStandardShare.directionalTextHelper, 'Standard', false) , $addDomHandler(optStandardShare, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames12, TYPE_0) , this$static.owner.optStandardShare = optStandardShare , optStandardShare)) , f_Grid30.element.style['width'] = '100%' , f_Grid30)) , $add_11(f_VerticalPanel7, (f_Label33 = new Label_0 , $setTextOrHtml(f_Label33.directionalTextHelper, "Le nombre de places \xE0 l'internat \xE9tant limit\xE9, une r\xE9servation en avance est recommand\xE9e.\nLes \xE9tudiants doivent arriver le dimanche apr\xE8s-midi et partir le samedi matin.", false) , $updateHorizontalAlignment(f_Label33) , f_Label33)) , $add_11(f_VerticalPanel7, (f_Label34 = new Label_0 , f_Label34.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label34.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label34) , f_Label34)) , $add_11(f_VerticalPanel7, (f_Label35 = new Label_0 , f_Label35.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label35.directionalTextHelper, 'D\xE9p\xF4t pour la cl\xE9', false) , $updateHorizontalAlignment(f_Label35) , f_Label35)) , $add_11(f_VerticalPanel7, (f_Label36 = new Label_0 , $setTextOrHtml(f_Label36.directionalTextHelper, 'Afin de recevoir la cl\xE9 de la chambre, les \xE9tudiants doivent effectuer un d\xE9p\xF4t \xE0 leur arriv\xE9e.\nCe montant leur sera restitu\xE9 \xE0 leur d\xE9part avec le retour de la cl\xE9. Il sera conserv\xE9 en cas de perte de la cl\xE9.', false) , $updateHorizontalAlignment(f_Label36) , f_Label36)) , $add_11(f_VerticalPanel7, (f_Grid37 = new Grid_0 , $resizeColumns(f_Grid37, 4) , $resizeRows(f_Grid37, 1) , $setWidget_1(f_Grid37, 0, 0, (f_Label38 = new Label_0 , $setTextOrHtml(f_Label38.directionalTextHelper, 'Choix de la monnaie du d\xE9p\xF4t', false) , $updateHorizontalAlignment(f_Label38) , f_Label38)) , $setWidget_1(f_Grid37, 0, 1, (optKeyDepositCHF = new RadioButton_0('deposit') , $setTextOrHtml(optKeyDepositCHF.directionalTextHelper, 'CHF 100.-', false) , $addDomHandler(optKeyDepositCHF, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames15, TYPE_0) , this$static.owner.optKeyDepositCHF = optKeyDepositCHF , optKeyDepositCHF)) , $setWidget_1(f_Grid37, 0, 2, (optKeyDepositEuro = new RadioButton_0('deposit') , $setTextOrHtml(optKeyDepositEuro.directionalTextHelper, '\u20AC 100.-', false) , $addDomHandler(optKeyDepositEuro, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames16, TYPE_0) , this$static.owner.optKeyDepositEuro = optKeyDepositEuro , optKeyDepositEuro)) , $setWidget_1(f_Grid37, 0, 3, (optKeyDepositUSD = new RadioButton_0('deposit') , $setTextOrHtml(optKeyDepositUSD.directionalTextHelper, 'US$ 100.-', false) , $addDomHandler(optKeyDepositUSD, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames17, TYPE_0) , this$static.owner.optKeyDepositUSD = optKeyDepositUSD , optKeyDepositUSD)) , f_Grid37.element.style['width'] = '100%' , f_Grid37)) , f_VerticalPanel7.element.style['width'] = '100%' , f_VerticalPanel7)) , $add_9(f_HorizontalPanel6, (f_VerticalPanel39 = new VerticalPanel_0 , $add_11(f_VerticalPanel39, (f_Label40 = new Label_0 , f_Label40.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label40.directionalTextHelper, 'ELEMENTS CHOISIS', false) , $updateHorizontalAlignment(f_Label40) , f_Label40)) , $add_11(f_VerticalPanel39, (tblItems = new FlexTable_0 , tblItems.element.style['width'] = '100%' , this$static.owner.tblItems = tblItems , tblItems)) , $add_11(f_VerticalPanel39, (f_HorizontalPanel41 = new HorizontalPanel_0 , $add_9(f_HorizontalPanel41, (f_Label42 = new Label_0 , f_Label42.element['className'] = 'lablel_TotalAmount' , $setTextOrHtml(f_Label42.directionalTextHelper, 'Total (CHF)', false) , $updateHorizontalAlignment(f_Label42) , f_Label42)) , $add_9(f_HorizontalPanel41, (lblTotalAmount = new Label_0 , lblTotalAmount.element['className'] = 'lablel_TotalAmount' , $setAutoHorizontalAlignment(lblTotalAmount, ALIGN_RIGHT) , $setTextOrHtml(lblTotalAmount.directionalTextHelper, '.', false) , $updateHorizontalAlignment(lblTotalAmount) , this$static.owner.lblTotalAmount = lblTotalAmount , lblTotalAmount)) , f_HorizontalPanel41.element.style['width'] = '100%' , f_HorizontalPanel41)) , f_VerticalPanel39.element['className'] = 'subSection' , f_VerticalPanel39.element.style['width'] = '250px' , f_VerticalPanel39)) , f_HorizontalPanel6.element.style['width'] = '100%' , f_HorizontalPanel6.table['cellSpacing'] = 10 , f_HorizontalPanel6)) , $add_7(f_FlowPanel5, (f_VerticalPanel43 = new VerticalPanel_0 , $setHorizontalAlignment_1(f_VerticalPanel43, ALIGN_RIGHT) , $add_11(f_VerticalPanel43, (f_HorizontalPanel44 = new HorizontalPanel_0 , $setHorizontalAlignment_0(f_HorizontalPanel44, ALIGN_RIGHT) , $add_9(f_HorizontalPanel44, (cmdPreviousStep = new Button_0 , $setHTML(cmdPreviousStep, (sb = new StringBuilder_0 , sb.impl.string += 'Pr\xE9c\xE9dant' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string)).html) , $addDomHandler(cmdPreviousStep, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames4, TYPE_0) , cmdPreviousStep)) , $add_9(f_HorizontalPanel44, (cmdNextStep = new Button_0 , $setHTML(cmdNextStep, (sb_0 = new StringBuilder_0 , sb_0.impl.string += 'Next Step' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb_0.impl.string)).html) , $setInnerText(cmdNextStep.element, 'Enregistrer & Suivant >>') , $addDomHandler(cmdNextStep, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, TYPE_0) , cmdNextStep)) , f_HorizontalPanel44.element.style['width'] = '35%' , f_HorizontalPanel44.table['cellSpacing'] = 10 , f_HorizontalPanel44)) , f_VerticalPanel43.element.style['width'] = '100%' , f_VerticalPanel43)) , f_FlowPanel5.element.style['width'] = '900px' , f_FlowPanel5)) , f_VerticalPanel1.element.style['height'] = '' , f_VerticalPanel1.element.style['width'] = '100%' , f_VerticalPanel1));
  this$static.owner.main = main;
  return main;
}

function ApplicationStep2View_BinderImpl$Widgets_0(owner){
  var f_Label17, lstStartDate, f_Label18, f_Label19, lstWeekNumber, f_Label20, f_Label21, f_Label22, f_Label23, f_Label24, txtJulyWeek, txtAugustWeek, f_Label25, f_Label26, f_Label27;
  ...
  this.owner = owner;
  this.f_Grid16 = new Grid_0;
  $resize(this.f_Grid16);
  $setWidget_1(this.f_Grid16, 0, 0, (f_Label17 = new Label_0 , $setTextOrHtml(f_Label17.directionalTextHelper, 'Date de d\xE9but', false) , $updateHorizontalAlignment(f_Label17) , f_Label17));
  $setWidget_1(this.f_Grid16, 0, 1, (lstStartDate = new ListBox_0 , $addDomHandler(lstStartDate, this.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this.owner.lstStartDate = lstStartDate , lstStartDate));
  $setWidget_1(this.f_Grid16, 0, 2, (f_Label18 = new Label_0 , $setTextOrHtml(f_Label18.directionalTextHelper, '(dd/MM/yyyy)', false) , $updateHorizontalAlignment(f_Label18) , f_Label18));
  $setWidget_1(this.f_Grid16, 1, 0, (f_Label19 = new Label_0 , $setTextOrHtml(f_Label19.directionalTextHelper, 'Nombre de semaines', false) , $updateHorizontalAlignment(f_Label19) , f_Label19));
  $setWidget_1(this.f_Grid16, 1, 1, (lstWeekNumber = new ListBox_0 , $addDomHandler(lstWeekNumber, this.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames3, TYPE) , this.owner.lstWeekNumber = lstWeekNumber , lstWeekNumber));
  $setWidget_1(this.f_Grid16, 1, 2, (f_Label20 = new Label_0 , $setTextOrHtml(f_Label20.directionalTextHelper, 'Reccomandation : au moins 2 semaines', false) , $updateHorizontalAlignment(f_Label20) , f_Label20));
  $setWidget_1(this.f_Grid16, 2, 0, (f_Label21 = new Label_0 , f_Label21.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label21.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label21) , f_Label21));
  $setWidget_1(this.f_Grid16, 2, 1, (f_Label22 = new Label_0 , $setTextOrHtml(f_Label22.directionalTextHelper, 'Juillet', false) , $updateHorizontalAlignment(f_Label22) , f_Label22));
  $setWidget_1(this.f_Grid16, 2, 2, (f_Label23 = new Label_0 , $setTextOrHtml(f_Label23.directionalTextHelper, 'Ao\xFBt', false) , $updateHorizontalAlignment(f_Label23) , f_Label23));
  $setWidget_1(this.f_Grid16, 3, 0, (f_Label24 = new Label_0 , f_Label24.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label24.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label24) , f_Label24));
  $setWidget_1(this.f_Grid16, 3, 1, (txtJulyWeek = new TextBox_0 , txtJulyWeek.element['className'] = 'sis_textbox_readonly' , txtJulyWeek.element['readOnly'] = true , $setStyleName_0(txtJulyWeek, getStylePrimaryName(txtJulyWeek.element) + '-readonly') , txtJulyWeek.element.style['width'] = '100px' , this.owner.txtJulyWeek = txtJulyWeek , txtJulyWeek));
  $setWidget_1(this.f_Grid16, 3, 2, (txtAugustWeek = new TextBox_0 , txtAugustWeek.element['className'] = 'sis_textbox_readonly' , txtAugustWeek.element['readOnly'] = true , $setStyleName_0(txtAugustWeek, getStylePrimaryName(txtAugustWeek.element) + '-readonly') , txtAugustWeek.element.style['width'] = '100px' , this.owner.txtAugustWeek = txtAugustWeek , txtAugustWeek));
  $setWidget_1(this.f_Grid16, 4, 0, (f_Label25 = new Label_0 , f_Label25.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label25.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label25) , f_Label25));
  $setWidget_1(this.f_Grid16, 4, 1, (f_Label26 = new Label_0 , $setTextOrHtml(f_Label26.directionalTextHelper, '(Cours standard)', false) , $updateHorizontalAlignment(f_Label26) , f_Label26));
  $setWidget_1(this.f_Grid16, 4, 2, (f_Label27 = new Label_0 , $setTextOrHtml(f_Label27.directionalTextHelper, '(Cours intensifs)', false) , $updateHorizontalAlignment(f_Label27) , f_Label27));
  $setWidth(this.f_Grid16, '100%');
  $setCellPadding(this.f_Grid16, 2);
}

defineSeed(1201, 1, {}, ApplicationStep2View_BinderImpl$Widgets_0);
_.f_Grid16 = null;
_.owner = null;
...
defineSeed(1202, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$1_0);
...
defineSeed(1203, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$10_0);
...
defineSeed(1204, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$11_0);
...
defineSeed(1205, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$12_0);
...
defineSeed(1206, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$13_0);
...
defineSeed(1207, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$14_0);
_.onClick = function onClick_13(event_0){
  $setOnLeaveConfirmation(dynamicCast(dynamicCast(this.this$1.owner.uiHandlers, Q$ApplicationStep2UiHandlers), Q$ApplicationStep2Presenter).placeManager, ($clinit_NotificationTypes() , 'Merci de cliquer sur Enregistrer pour sauvegarder les informations modifi\xE9es.'));
}
;
_.this$1 = null;
...
defineSeed(1208, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$15_0);
...
defineSeed(1209, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$16_0);
...
defineSeed(1210, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$17_0);
...
defineSeed(1211, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$2_0);
...
defineSeed(1212, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$3_0);
...
defineSeed(1213, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$4_0);
...
defineSeed(1214, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$5_0);
...
defineSeed(1215, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$6_0);
...
defineSeed(1216, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$7_0);
...
defineSeed(1217, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$8_0);
...
defineSeed(1218, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$9_0);
...
defineSeed(1222, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1414, 727, {}, MainPagePresenterMyProxyImpl$8_0);
...
defineSeed(1415, 1, {}, MainPagePresenterMyProxyImpl$8$1_0);
_.execute_1 = function execute_95(){
  $clinit_History();
  !!impl_2 && $newItem(impl_2, 'applicationstep3', true);
}
;
...
defineSeed(1815, 657, makeCastMap([Q$AbstractRequest]), ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$10X_0);
_.makeRequestData = function makeRequestData(){
  return new RequestData_0('Y_ughKww3zb3de0bkQI6SpxXYQA=', initValues(_3Ljava_lang_Object_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1]), Q$Object, [this.val$emailAddress, this.val$appId, ($clinit_Boolean() , this.val$chkApplicaitonFee?TRUE_1:FALSE_1), this.val$chkPackAssurance?TRUE_1:FALSE_1, this.val$programmesCode, this.val$courseCode, this.val$startDate, this.val$weekNumber, this.val$txtJulyWeek, this.val$txtAugustWeek, this.val$chkContinueAfter?TRUE_1:FALSE_1, this.val$optConfortPlusPrivate?TRUE_1:FALSE_1, this.val$optConfortPrivate?TRUE_1:FALSE_1, this.val$optStandardPrivate?TRUE_1:FALSE_1, this.val$optConfortPlusShare?TRUE_1:FALSE_1, this.val$optConfortShare?TRUE_1:FALSE_1, this.val$optStandardShare?TRUE_1:FALSE_1, this.val$optKeyDepositCHF?TRUE_1:FALSE_1, this.val$optKeyDepositEuro?TRUE_1:FALSE_1, this.val$optKeyDepositUSD?TRUE_1:FALSE_1]), this.propertyRefs, Ljava_lang_Boolean_2_classLit, null);
}
;
_.val$appId = null;
...
defineSeed(2024, 1, makeCastMap([Q$CharSequence]), StringBuffer_1);
var Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2Presenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2Presenter', 1189), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2Presenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2Presenter$1', 1190), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2Presenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2Presenter$2', 1191), Lcom_lemania_eprospects_client_event_ApplicationStep2CompletedEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStep2CompletedEvent', 776), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$8', 1414), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$8$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$8$1', 1415), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View', 1199), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl', 1200), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets', 1201), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$1', 1202), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$2', 1211), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$3', 1212), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$4', 1213), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$5', 1214), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$6', 1215), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$7', 1216), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$8', 1217), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$9', 1218), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$10', 1203), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$11_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$11', 1204), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$12_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$12', 1205), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$13_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$13', 1206), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$14_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$14', 1207), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$15_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$15', 1208), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$16_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$16', 1209), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$17_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$17', 1210), Lcom_google_gwt_i18n_shared_DateTimeFormat_2_classLit = createForClass('com.google.gwt.i18n.shared.', 'DateTimeFormat', 296), Lcom_google_gwt_i18n_shared_DateTimeFormat$PatternPart_2_classLit = createForClass('com.google.gwt.i18n.shared.', 'DateTimeFormat$PatternPart', 297), Lcom_google_gwt_i18n_shared_impl_DateRecord_2_classLit = createForClass('com.google.gwt.i18n.shared.impl.', 'DateRecord', 298), Lcom_google_gwt_i18n_client_TimeZone_2_classLit = createForClass('com.google.gwt.i18n.client.', 'TimeZone', 292), Lcom_google_gwt_i18n_shared_DefaultDateTimeFormatInfo_2_classLit = createForClass('com.google.gwt.i18n.shared.', 'DefaultDateTimeFormatInfo', 288), Lcom_google_gwt_i18n_client_DefaultDateTimeFormatInfo_2_classLit = createForClass('com.google.gwt.i18n.client.', 'DefaultDateTimeFormatInfo', 287), Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr.', 'DateTimeFormatInfoImpl', 295), Lcom_lemania_eprospects_shared_applicationform_ApplicationFormRequestFactory_1ApplicationFormRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.applicationform.', 'ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$10X', 1815);
$entry(onLoad)(5);
