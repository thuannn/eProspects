...
defineSeed(993, 715, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmSubjectAddPresenter, Q$FrmSubjectAddUiHandler]), FrmSubjectAddPresenter_0);
...
defineSeed(994, 655, makeCastMap([Q$Receiver]), FrmSubjectAddPresenter$1_0);
...
defineSeed(1633, 720, makeCastMap([Q$IsWidget, Q$FrmSubjectAddPresenter$MyView]), FrmSubjectAddView_0);
...
defineSeed(1634, 10, makeCastMap([Q$Timer]), FrmSubjectAddView$1_0);
...
defineSeed(1635, 1, {}, FrmSubjectAddView_BinderImpl_0);
...
defineSeed(1636, 1, {}, FrmSubjectAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1637, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmSubjectAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1969, 659, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$6X_0);
...
;
_.val$subject = null;
var Lcom_lemania_eprospects_client_presenter_FrmSubjectAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmSubjectAddPresenter', 993), Lcom_lemania_eprospects_client_presenter_FrmSubjectAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmSubjectAddPresenter$1', 994), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView', 1633), Lcom_lemania_eprospects_client_view_FrmSubjectAddView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView$1', 1634), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl', 1635), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets', 1636), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets$1', 1637), Lcom_lemania_eprospects_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$6X', 1969);
$entry(onLoad)(27);
