...
defineSeed(769, 233, {}, ApplicationStep4CompletedEvent_0);
...
defineSeed(1251, 704, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationItemSavedEvent$ApplicationItemSavedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ApplicationStep4Presenter, Q$ApplicationStep4UiHandlers]), ApplicationStep4Presenter_0);
...
defineSeed(1252, 644, makeCastMap([Q$Receiver]), ApplicationStep4Presenter$1_0);
...
defineSeed(1253, 644, makeCastMap([Q$Receiver]), ApplicationStep4Presenter$2_0);
...
function $showApplicationDetails_3(this$static, app){
  ...
  $setValue_0(this$static.optHealthProblemYes, ($clinit_Boolean() , app.isOptHealthProblemYes()?TRUE_1:FALSE_1));
  $setValue_0(this$static.optHealProblemNo, app.isOptHealProblemNo()?TRUE_1:FALSE_1);
  $setText(this$static.txtHealthProblem, app.getTxtHealthProblem());
  $setValue_0(this$static.optAllergyYes, app.isOptAllergyYes()?TRUE_1:FALSE_1);
  $setValue_0(this$static.optAllergyNo, app.isOptAllergyNo()?TRUE_1:FALSE_1);
  $setText(this$static.txtAllergy, app.getTxtAllergy());
  $setValue_0(this$static.optMedicalYes, app.isOptMedicalYes()?TRUE_1:FALSE_1);
  $setValue_0(this$static.optMedicalNo, app.isOptMedicalNo()?TRUE_1:FALSE_1);
...
defineSeed(1261, 709, makeCastMap([Q$IsWidget, Q$ApplicationStep4Presenter$MyView]), ApplicationStep4View_0);
...
defineSeed(1262, 1, {}, ApplicationStep4View_BinderImpl_0);
...
defineSeed(1263, 1, {}, ApplicationStep4View_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationStep4View_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1264, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$1_0);
...
defineSeed(1265, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$10_0);
...
defineSeed(1266, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$11_0);
...
defineSeed(1267, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$12_0);
...
defineSeed(1268, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$2_0);
...
defineSeed(1269, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$3_0);
...
defineSeed(1270, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$4_0);
...
defineSeed(1271, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$5_0);
...
defineSeed(1272, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$6_0);
...
defineSeed(1273, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$7_0);
...
defineSeed(1274, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$8_0);
...
defineSeed(1275, 1, makeCastMap([Q$ValueChangeHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$9_0);
...
defineSeed(1279, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1387, 718, {}, MainPagePresenterMyProxyImpl$12_0);
...
defineSeed(1388, 1, {}, MainPagePresenterMyProxyImpl$12$1_0);
...
defineSeed(1808, 648, makeCastMap([Q$AbstractRequest]), ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$12X_0);
...
_.val$txtOther = null;
var Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4Presenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4Presenter', 1251), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4Presenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4Presenter$1', 1252), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4Presenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4Presenter$2', 1253), Lcom_lemania_eprospects_client_event_ApplicationStep4CompletedEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStep4CompletedEvent', 769), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$12_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$12', 1387), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$12$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$12$1', 1388), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View', 1261), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl', 1262), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets', 1263), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$1', 1264), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$2', 1268), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$3', 1269), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$4', 1270), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$5', 1271), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$6', 1272), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$7', 1273), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$8', 1274), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$9', 1275), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$10', 1265), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$11_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$11', 1266), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$12_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$12', 1267), Lcom_lemania_eprospects_shared_applicationform_ApplicationFormRequestFactory_1ApplicationFormRequestContextImpl$12X_2_classLit = createForClass('com.lemania.eprospects.shared.applicationform.', 'ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$12X', 1808);
$entry(onLoad)(7);
