...
defineSeed(761, 238, {}, ApplicationPaymentEvent_0);
...
defineSeed(1115, 706, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationPaymentPresenter, Q$ApplicationPaymentUiHandlers]), ApplicationPaymentPresenter_0);
...
defineSeed(1118, 711, makeCastMap([Q$IsWidget, Q$ApplicationPaymentPresenter$MyView, Q$ApplicationPaymentView]), ApplicationPaymentView_0);
...
defineSeed(1119, 1, {}, ApplicationPaymentView_BinderImpl_0);
...
defineSeed(1120, 1, {}, ApplicationPaymentView_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationPaymentView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1121, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationPaymentView_BinderImpl$Widgets$1_0);
...
defineSeed(1122, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationPaymentView_BinderImpl$Widgets$2_0);
...
defineSeed(1123, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationPaymentView_BinderImpl$Widgets$3_0);
...
defineSeed(1124, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationPaymentView_BinderImpl$Widgets$4_0);
...
defineSeed(1128, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1261, 719, {}, MainPagePresenterMyProxyImpl$10_0);
...
defineSeed(1262, 1, {}, MainPagePresenterMyProxyImpl$10$1_0);
_.execute_1 = function execute_72(){
  $clinit_History();
  !!impl_2 && $newItem(impl_2, 'applicationfinal', true);
}
;
var Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentPresenter', 1115), Lcom_lemania_eprospects_client_event_ApplicationPaymentEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationPaymentEvent', 761), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$10', 1261), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$10$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$10$1', 1262), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView', 1118), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl', 1119), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets', 1120), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets$1', 1121), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets$2', 1122), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets$3', 1123), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets$4', 1124);
$entry(onLoad)(3);
