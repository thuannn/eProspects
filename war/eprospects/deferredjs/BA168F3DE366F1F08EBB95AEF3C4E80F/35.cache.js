...
defineSeed(988, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmSubjectListPresenter, Q$FrmSubjectListUiHandler]), FrmSubjectListPresenter_0);
...
defineSeed(1482, 710, makeCastMap([Q$IsWidget, Q$FrmSubjectListPresenter$MyView]), FrmSubjectListView_0);
...
defineSeed(1483, 366, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$1_0);
...
defineSeed(1485, 366, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$3_0);
...
defineSeed(1487, 366, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$5_0);
...
defineSeed(1785, 648, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$2X_0);
...
defineSeed(1789, 648, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$7X_0);
