...
defineSeed(786, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ContactPresenter, Q$ContactUiHandler]), ContactPresenter_0);
...
defineSeed(787, 644, makeCastMap([Q$Receiver]), ContactPresenter$1_0);
...
defineSeed(1263, 710, makeCastMap([Q$IsWidget, Q$ContactPresenter$MyView]), ContactView_0);
...
defineSeed(1706, 639, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1707, 649, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1708, 648, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$1X_0);
...
defineSeed(1709, 577, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
