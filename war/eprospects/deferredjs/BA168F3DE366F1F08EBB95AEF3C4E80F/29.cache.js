...
defineSeed(778, 235, {}, ProfileBrancheAfterAddEvent_0);
...
defineSeed(1004, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfileBrancheAfterAddEvent$ProfileBrancheAfterAddHandler, Q$ProfileManagementPresenter, Q$ProfileManagementUiHandler]), ProfileManagementPresenter_0);
...
defineSeed(1005, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$1_0);
...
defineSeed(1006, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$10_0);
...
defineSeed(1007, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$11_0);
...
defineSeed(1008, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$12_0);
...
defineSeed(1009, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$13_0);
...
defineSeed(1010, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$14_0);
...
defineSeed(1011, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$15_0);
...
defineSeed(1012, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$2_0);
...
defineSeed(1013, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$3_0);
...
defineSeed(1014, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$4_0);
...
defineSeed(1015, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$5_0);
...
defineSeed(1016, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$6_0);
...
defineSeed(1017, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$7_0);
...
defineSeed(1018, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$8_0);
...
defineSeed(1019, 644, makeCastMap([Q$Receiver]), ProfileManagementPresenter$9_0);
...
;
_.this$0 = null;
defineSeed(1020, 736, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfileBrancheAfterAddEvent$ProfileBrancheAfterAddHandler]));
...
defineSeed(1021, 718, {}, ProfileManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1022, 1, {}, ProfileManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1202, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1499, 710, makeCastMap([Q$IsWidget, Q$ProfileManagementPresenter$MyView]), ProfileManagementView_0);
...
defineSeed(1500, 392, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$1_0);
...
defineSeed(1502, 392, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$11_0);
...
defineSeed(1503, 366, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$12_0);
...
defineSeed(1505, 366, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$14_0);
...
defineSeed(1507, 366, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$2_0);
...
defineSeed(1509, 392, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$4_0);
...
defineSeed(1510, 366, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$5_0);
...
defineSeed(1512, 392, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$7_0);
...
defineSeed(1513, 366, makeCastMap([Q$HasCell, Q$Column]), ProfileManagementView$8_0);
...
defineSeed(1640, 605, makeCastMap([Q$AutoBean, Q$AbstractAutoBean, Q$HasSplittable]), ProfileSubjectProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_0, ProfileSubjectProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_1);
_.as = function as_22(){
  return this.shim;
}
;
...
defineSeed(1751, 639, {}, ProfileBrancheRequestFactoryImpl_0);
...
defineSeed(1752, 649, makeCastMap([Q$AbstractRequestContext]), ProfileBrancheRequestFactory_ProfileBrancheRequestContextImpl_0);
...
defineSeed(1753, 648, makeCastMap([Q$AbstractRequest]), ProfileBrancheRequestFactory_ProfileBrancheRequestContextImpl$3X_0);
...
defineSeed(1754, 648, makeCastMap([Q$AbstractRequest]), ProfileBrancheRequestFactory_ProfileBrancheRequestContextImpl$5X_0);
...
defineSeed(1755, 648, makeCastMap([Q$AbstractRequest]), ProfileBrancheRequestFactory_ProfileBrancheRequestContextImpl$7X_0);
...
defineSeed(1756, 648, makeCastMap([Q$AbstractRequest]), ProfileBrancheRequestFactory_ProfileBrancheRequestContextImpl$8X_0);
...
defineSeed(1757, 577, makeCastMap([Q$EnumMap]), ProfileBrancheRequestFactory_ProfileBrancheRequestContextImpl_FactoryImpl_0);
...
defineSeed(1761, 648, makeCastMap([Q$AbstractRequest]), ProfileRequestFactory_ProfileRequestContextImpl$8X_0);
...
defineSeed(1763, 639, {}, ProfileSubjectRequestFactoryImpl_0);
...
defineSeed(1764, 649, makeCastMap([Q$AbstractRequestContext]), ProfileSubjectRequestFactory_ProfileSubjectRequestContextImpl_0);
...
defineSeed(1765, 648, makeCastMap([Q$AbstractRequest]), ProfileSubjectRequestFactory_ProfileSubjectRequestContextImpl$1X_0);
...
defineSeed(1766, 648, makeCastMap([Q$AbstractRequest]), ProfileSubjectRequestFactory_ProfileSubjectRequestContextImpl$4X_0);
...
defineSeed(1767, 648, makeCastMap([Q$AbstractRequest]), ProfileSubjectRequestFactory_ProfileSubjectRequestContextImpl$6X_0);
...
defineSeed(1768, 648, makeCastMap([Q$AbstractRequest]), ProfileSubjectRequestFactory_ProfileSubjectRequestContextImpl$8X_0);
...
defineSeed(1769, 648, makeCastMap([Q$AbstractRequest]), ProfileSubjectRequestFactory_ProfileSubjectRequestContextImpl$9X_0);
...
defineSeed(1770, 577, makeCastMap([Q$EnumMap]), ProfileSubjectRequestFactory_ProfileSubjectRequestContextImpl_FactoryImpl_0);
