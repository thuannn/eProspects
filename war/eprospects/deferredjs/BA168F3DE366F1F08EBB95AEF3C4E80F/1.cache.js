...
defineSeed(1091, 705, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget]), ApplicationFinalPresenter_0);
...
defineSeed(1094, 710, makeCastMap([Q$IsWidget, Q$ApplicationFinalPresenter$MyView]), ApplicationFinalView_0);
...
defineSeed(1099, 1, makeCastMap([Q$RunAsyncCallback]));
