...
defineSeed(826, 706, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheAddPresenter, Q$FrmBrancheAddUiHandler]), FrmBrancheAddPresenter_0);
...
defineSeed(827, 646, makeCastMap([Q$Receiver]), FrmBrancheAddPresenter$1_0);
...
defineSeed(1305, 711, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(1306, 10, makeCastMap([Q$Timer]), FrmBrancheAddView$1_0);
...
defineSeed(1307, 1, {}, FrmBrancheAddView_BinderImpl_0);
...
defineSeed(1308, 1, {}, FrmBrancheAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1309, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBrancheAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1674, 650, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
...
;
_.val$branche = null;
var Lcom_lemania_eprospects_client_presenter_FrmBrancheAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheAddPresenter', 826), Lcom_lemania_eprospects_client_presenter_FrmBrancheAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheAddPresenter$1', 827), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView', 1305), Lcom_lemania_eprospects_client_view_FrmBrancheAddView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView$1', 1306), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl', 1307), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets', 1308), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets$1', 1309), Lcom_lemania_eprospects_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$4X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$4X', 1674);
$entry(onLoad)(14);
