...
defineSeed(781, 234, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(865, 646, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
defineSeed(1065, 646, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1066, 646, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1067, 646, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1068, 646, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1069, 646, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1081, 646, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1574, 711, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1575, 371, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1576, 1, {}, StudentView$2_0);
...
defineSeed(1577, 371, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1578, 1, {}, StudentView$4_0);
...
defineSeed(1579, 371, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1580, 1, {}, StudentView$6_0);
...
defineSeed(1581, 371, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1582, 1, {}, StudentView$8_0);
...
defineSeed(1583, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1584, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1690, 650, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1786, 650, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1788, 650, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1802, 650, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
