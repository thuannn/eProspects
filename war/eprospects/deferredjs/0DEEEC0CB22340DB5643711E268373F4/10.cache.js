...
defineSeed(781, 235, {}, CoursAddedEvent_0);
...
defineSeed(799, 711, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursAddPresenter, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(800, 651, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(801, 651, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(811, 743, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(812, 725, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(813, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(1421, 716, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1422, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(1423, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1424, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1425, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1891, 655, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_eprospects_client_presenter_CoursAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursAddPresenter', 799), Lcom_lemania_eprospects_client_presenter_CoursAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursAddPresenter$1', 800), Lcom_lemania_eprospects_client_presenter_CoursAddPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursAddPresenter$2', 801), Lcom_lemania_eprospects_client_event_CoursAddedEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'CoursAddedEvent', 781), Lcom_lemania_eprospects_client_presenter_CoursPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenterMyProxyImpl$1', 812), Lcom_lemania_eprospects_client_presenter_CoursPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenterMyProxyImpl$1$1', 813), Lcom_lemania_eprospects_client_view_CoursAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView', 1421), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl', 1422), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl$Widgets', 1423), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl$Widgets$1', 1424), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl$Widgets$2', 1425), Lcom_lemania_eprospects_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$7X', 1891);
$entry(onLoad)(10);
