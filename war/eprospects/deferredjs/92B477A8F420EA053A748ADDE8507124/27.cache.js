...
defineSeed(980, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmSubjectAddPresenter, Q$FrmSubjectAddUiHandler]), FrmSubjectAddPresenter_0);
...
defineSeed(981, 642, makeCastMap([Q$Receiver]), FrmSubjectAddPresenter$1_0);
...
defineSeed(1490, 707, makeCastMap([Q$IsWidget, Q$FrmSubjectAddPresenter$MyView]), FrmSubjectAddView_0);
...
defineSeed(1491, 12, makeCastMap([Q$Timer]), FrmSubjectAddView$1_0);
...
defineSeed(1492, 1, {}, FrmSubjectAddView_BinderImpl_0);
...
defineSeed(1493, 1, {}, FrmSubjectAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1494, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmSubjectAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1802, 646, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$6X_0);
...
;
_.val$subject = null;
var Lcom_lemania_eprospects_client_presenter_FrmSubjectAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmSubjectAddPresenter', 980), Lcom_lemania_eprospects_client_presenter_FrmSubjectAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmSubjectAddPresenter$1', 981), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView', 1490), Lcom_lemania_eprospects_client_view_FrmSubjectAddView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView$1', 1491), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl', 1492), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets', 1493), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets$1', 1494), Lcom_lemania_eprospects_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$6X', 1802);
$entry(onLoad)(27);
