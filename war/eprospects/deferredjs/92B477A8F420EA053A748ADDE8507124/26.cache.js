...
defineSeed(974, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmPasswordPresenter, Q$FrmPasswordUiHandler]), FrmPasswordPresenter_0);
...
defineSeed(975, 642, makeCastMap([Q$Receiver]), FrmPasswordPresenter$1_0);
...
defineSeed(1485, 707, makeCastMap([Q$IsWidget, Q$FrmPasswordPresenter$MyView]), FrmPasswordView_0);
...
defineSeed(1486, 1, {}, FrmPasswordView_BinderImpl_0);
...
defineSeed(1487, 1, {}, FrmPasswordView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1488, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmPasswordView_BinderImpl$Widgets$1_0);
...
defineSeed(1810, 646, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
...
_.val$password = null;
_.val$userName = null;
var Lcom_lemania_eprospects_client_presenter_FrmPasswordPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmPasswordPresenter', 974), Lcom_lemania_eprospects_client_presenter_FrmPasswordPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmPasswordPresenter$1', 975), Lcom_lemania_eprospects_client_view_FrmPasswordView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmPasswordView', 1485), Lcom_lemania_eprospects_client_view_FrmPasswordView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmPasswordView_BinderImpl', 1486), Lcom_lemania_eprospects_client_view_FrmPasswordView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmPasswordView_BinderImpl$Widgets', 1487), Lcom_lemania_eprospects_client_view_FrmPasswordView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmPasswordView_BinderImpl$Widgets$1', 1488), Lcom_lemania_eprospects_shared_service_UserRequestFactory_1UserRequestContextImpl$2X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'UserRequestFactory_UserRequestContextImpl$2X', 1810);
$entry(onLoad)(26);
