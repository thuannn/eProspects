...
defineSeed(791, 234, {}, StudentAfterStatusChangeEvent_0);
_.dispatch_0 = function dispatch_59(handler){
...
defineSeed(862, 709, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler, Q$FrmBulletinManagementPresenter, Q$FrmBulletinManagementUiHandler]));
...
defineSeed(869, 649, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(879, 741, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(880, 723, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(881, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
function $updateStudentEmail(this$static, student, email){
  ...
  $fire($saveAndReturn_3(rc, studentForUpdate), new StudentPresenter$5_0(this$static));
}
...
function $updateStudentFirstName(this$static, student, firstName){
  ...
  $fire($saveAndReturn_3(rc, studentForUpdate), new StudentPresenter$3_0(this$static));
}
...
function $updateStudentLastName(this$static, student, lastName){
  ...
  $fire($saveAndReturn_3(rc, studentForUpdate), new StudentPresenter$4_0(this$static));
}
...
function $updateStudentStatus(this$static, student, value){
  ...
  $fire($saveAndReturn_3(rc, studentForUpdate), new StudentPresenter$2_0(this$static, student, value));
}
...
defineSeed(1068, 709, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1069, 649, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
_.onFailure_0 = function onFailure_125(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_125(response){
  $onSuccess_120(this, dynamicCast(response, Q$List));
}
;
_.this$0 = null;
function $onSuccess_121(this$static, response){
  ...
  $doFire(this$static.this$0.eventBus, new StudentAfterStatusChangeEvent_0('' + toString_7(this$static.val$student.getId_0().value_0), this$static.val$student.getEmail(), this$static.val$value), null);
}
...
defineSeed(1070, 649, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1071, 649, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1072, 649, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1073, 649, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1085, 649, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
;
function $success_38(this$static, presenter){
...
defineSeed(1091, 723, {}, UserManagementPresenterMyProxyImpl$3_0);
_.success = function success_40(presenter){
  $success_38(this, dynamicCast(presenter, Q$UserManagementPresenter));
}
;
_.val$event = null;
...
defineSeed(1092, 1, {}, UserManagementPresenterMyProxyImpl$3$1_0);
...
defineSeed(1717, 714, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1718, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1719, 1, {}, StudentView$2_0);
...
defineSeed(1720, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1721, 1, {}, StudentView$4_0);
...
defineSeed(1722, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1723, 1, {}, StudentView$6_0);
...
defineSeed(1724, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1725, 1, {}, StudentView$8_0);
...
defineSeed(1726, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1727, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1798, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
;
defineSeed(1799, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1856, 653, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
function $saveAndReturn_3(this$static, newStudent){
  var x;
...
defineSeed(1953, 653, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1955, 653, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1969, 653, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
...
var Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$15_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$15', 869), Lcom_lemania_eprospects_client_event_StudentAfterStatusChangeEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'StudentAfterStatusChangeEvent', 791), Lcom_lemania_eprospects_client_presenter_StudentPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'StudentPresenter', 1068), Lcom_lemania_eprospects_client_presenter_StudentPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'StudentPresenter$1', 1069), Lcom_lemania_eprospects_client_presenter_StudentPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'StudentPresenter$2', 1070), Lcom_lemania_eprospects_client_presenter_StudentPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'StudentPresenter$3', 1071), Lcom_lemania_eprospects_client_presenter_StudentPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'StudentPresenter$4', 1072), Lcom_lemania_eprospects_client_presenter_StudentPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'StudentPresenter$5', 1073), Lcom_lemania_eprospects_client_presenter_UserManagementPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'UserManagementPresenter$7', 1085), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1', 880), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1$1', 881), Lcom_lemania_eprospects_client_presenter_UserManagementPresenterMyProxyImpl$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'UserManagementPresenterMyProxyImpl$3', 1091), Lcom_lemania_eprospects_client_presenter_UserManagementPresenterMyProxyImpl$3$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'UserManagementPresenterMyProxyImpl$3$1', 1092), Lcom_lemania_eprospects_client_view_StudentView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView', 1717), Lcom_lemania_eprospects_client_view_StudentView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$1', 1718), Lcom_lemania_eprospects_client_view_StudentView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$2', 1719), Lcom_lemania_eprospects_client_view_StudentView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$3', 1720), Lcom_lemania_eprospects_client_view_StudentView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$4', 1721), Lcom_lemania_eprospects_client_view_StudentView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$5', 1722), Lcom_lemania_eprospects_client_view_StudentView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$6', 1723), Lcom_lemania_eprospects_client_view_StudentView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$7', 1724), Lcom_lemania_eprospects_client_view_StudentView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView$8', 1725), Lcom_lemania_eprospects_client_view_StudentView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView_BinderImpl', 1726), Lcom_lemania_eprospects_client_view_StudentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'StudentView_BinderImpl$Widgets', 1727), Lcom_lemania_eprospects_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$13X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$13X', 1856), Lcom_lemania_eprospects_shared_service_StudentRequestFactory_1StudentRequestContextImpl$1X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$1X', 1953), Lcom_lemania_eprospects_shared_service_StudentRequestFactory_1StudentRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$7X', 1955), Lcom_lemania_eprospects_shared_service_UserRequestFactory_1UserRequestContextImpl$12X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'UserRequestFactory_UserRequestContextImpl$12X', 1969);
$entry(onLoad)(34);
