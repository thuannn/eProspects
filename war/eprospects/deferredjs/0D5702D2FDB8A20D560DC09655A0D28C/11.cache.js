...
defineSeed(804, 709, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(805, 649, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(806, 649, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(807, 649, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(808, 649, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1425, 714, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1426, 373, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1427, 1, {}, CoursView$2_0);
...
defineSeed(1428, 373, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1429, 1, {}, CoursView$4_0);
...
defineSeed(1430, 1, {}, CoursView_BinderImpl_0);
...
defineSeed(1431, 1, {}, CoursView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1432, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), CoursView_BinderImpl$Widgets$1_0);
...
defineSeed(1890, 653, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
...
;
_.val$newCours = null;
var Lcom_lemania_eprospects_client_presenter_CoursPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter', 804), Lcom_lemania_eprospects_client_presenter_CoursPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$1', 805), Lcom_lemania_eprospects_client_presenter_CoursPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$2', 806), Lcom_lemania_eprospects_client_presenter_CoursPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$3', 807), Lcom_lemania_eprospects_client_presenter_CoursPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$4', 808), Lcom_lemania_eprospects_client_view_CoursView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView', 1425), Lcom_lemania_eprospects_client_view_CoursView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$1', 1426), Lcom_lemania_eprospects_client_view_CoursView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$2', 1427), Lcom_lemania_eprospects_client_view_CoursView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$3', 1428), Lcom_lemania_eprospects_client_view_CoursView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$4', 1429), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl', 1430), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl$Widgets', 1431), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl$Widgets$1', 1432), Lcom_lemania_eprospects_shared_service_CoursRequestFactory_1CoursRequestContextImpl$8X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$8X', 1890);
$entry(onLoad)(11);
