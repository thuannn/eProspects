...
defineSeed(755, 238, {}, ApplicationStep3CompletedEvent_0);
...
defineSeed(1132, 696, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationStep3Presenter, Q$ApplicationStep3UiHandlers]), ApplicationStep3Presenter_0);
...
defineSeed(1135, 701, makeCastMap([Q$IsWidget, Q$ApplicationStep3Presenter$MyView]), ApplicationStep3View_0);
...
defineSeed(1136, 1, {}, ApplicationStep3View_BinderImpl_0);
...
defineSeed(1137, 1, {}, ApplicationStep3View_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationStep3View_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1138, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep3View_BinderImpl$Widgets$1_0);
...
defineSeed(1231, 709, {}, MainPagePresenterMyProxyImpl$13_0);
...
defineSeed(1232, 1, {}, MainPagePresenterMyProxyImpl$13$1_0);
_.execute_1 = function execute_72(){
  $clinit_History();
  !!impl_2 && $newItem(impl_2, 'applicationstep4', true);
}
;
var Lcom_lemania_eprospects_client_presenter_applicationstep3_ApplicationStep3Presenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep3.', 'ApplicationStep3Presenter', 1132), Lcom_lemania_eprospects_client_event_ApplicationStep3CompletedEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStep3CompletedEvent', 755), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$13_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$13', 1231), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$13$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$13$1', 1232), Lcom_lemania_eprospects_client_presenter_applicationstep3_ApplicationStep3View_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep3.', 'ApplicationStep3View', 1135), Lcom_lemania_eprospects_client_presenter_applicationstep3_ApplicationStep3View_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep3.', 'ApplicationStep3View_BinderImpl', 1136), Lcom_lemania_eprospects_client_presenter_applicationstep3_ApplicationStep3View_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep3.', 'ApplicationStep3View_BinderImpl$Widgets', 1137), Lcom_lemania_eprospects_client_presenter_applicationstep3_ApplicationStep3View_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep3.', 'ApplicationStep3View_BinderImpl$Widgets$1', 1138);
$entry(onLoad)(6);
