...
defineSeed(761, 238, {}, CoursAddedEvent_0);
...
defineSeed(783, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursAddPresenter, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(784, 635, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(785, 635, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(795, 727, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(796, 709, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(797, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(1259, 701, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1260, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(1261, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1262, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1263, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1705, 639, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_eprospects_client_presenter_CoursAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursAddPresenter', 783), Lcom_lemania_eprospects_client_presenter_CoursAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursAddPresenter$1', 784), Lcom_lemania_eprospects_client_presenter_CoursAddPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursAddPresenter$2', 785), Lcom_lemania_eprospects_client_event_CoursAddedEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'CoursAddedEvent', 761), Lcom_lemania_eprospects_client_presenter_CoursPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenterMyProxyImpl$1', 796), Lcom_lemania_eprospects_client_presenter_CoursPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenterMyProxyImpl$1$1', 797), Lcom_lemania_eprospects_client_view_CoursAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView', 1259), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl', 1260), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl$Widgets', 1261), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl$Widgets$1', 1262), Lcom_lemania_eprospects_client_view_CoursAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursAddView_BinderImpl$Widgets$2', 1263), Lcom_lemania_eprospects_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$7X', 1705);
$entry(onLoad)(10);
