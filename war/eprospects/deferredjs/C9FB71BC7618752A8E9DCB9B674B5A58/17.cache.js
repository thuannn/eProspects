...
function $onClassChange(this$static, classId){
  var rc, rf;
  if (!classId.length) {
    alert_0(($clinit_NotificationTypes() , 'Missing input : ') + ' - Classe choisie');
    return;
  }
...
function $updateBrancheCoef(this$static, branche, coef){
  ...
  if (!$matches(coef, '-?\\d+(\\.\\d+)?')) {
    alert_0(($clinit_NotificationTypes() , 'Missing input : ') + ' - Coefficient');
    return;
  }
  rf = new BulletinBrancheRequestFactoryImpl_0;
  $initialize_0(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
...
defineSeed(878, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$1_0);
...
defineSeed(879, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$10_0);
...
defineSeed(880, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$11_0);
...
defineSeed(881, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$12_0);
...
defineSeed(882, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$13_0);
...
defineSeed(883, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$14_0);
...
defineSeed(885, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$16_0);
...
defineSeed(886, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$2_0);
...
defineSeed(887, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$3_0);
...
defineSeed(888, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$4_0);
...
defineSeed(889, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$5_0);
...
defineSeed(890, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$6_0);
...
defineSeed(891, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$7_0);
...
defineSeed(892, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$8_0);
...
defineSeed(893, 664, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$9_0);
...
defineSeed(1374, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1498, 729, makeCastMap([Q$IsWidget, Q$FrmBulletinManagementPresenter$MyView]), FrmBulletinManagementView_0);
...
defineSeed(1499, 407, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$1_0);
...
defineSeed(1500, 407, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$10_0);
...
defineSeed(1501, 381, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$11_0);
...
defineSeed(1502, 1, {}, FrmBulletinManagementView$12_0);
...
defineSeed(1503, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$13_0);
...
defineSeed(1504, 407, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$14_0);
...
defineSeed(1505, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$15_0);
...
defineSeed(1506, 381, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$2_0);
...
defineSeed(1507, 1, {}, FrmBulletinManagementView$3_0);
...
defineSeed(1508, 381, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$4_0);
...
defineSeed(1509, 1, {}, FrmBulletinManagementView$5_0);
...
defineSeed(1510, 407, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$6_0);
...
defineSeed(1511, 381, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$7_0);
...
defineSeed(1512, 1, {}, FrmBulletinManagementView$8_0);
...
defineSeed(1513, 407, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$9_0);
...
defineSeed(1514, 1, {}, FrmBulletinManagementView_BinderImpl_0);
...
defineSeed(1515, 1, {}, FrmBulletinManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1516, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1517, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1518, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$3_0);
...
defineSeed(1519, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$4_0);
...
defineSeed(1520, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$5_0);
...
defineSeed(1521, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$6_0);
...
defineSeed(1771, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1772, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
_.setBrancheCoef = function setBrancheCoef_0(brancheCoef){
  $setProperty(this.this$0, 'brancheCoef', brancheCoef);
}
;
defineSeed(1777, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
;
defineSeed(1778, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
defineSeed(1860, 668, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0);
...
defineSeed(1864, 668, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0);
...
defineSeed(1881, 668, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0);
...
defineSeed(1884, 668, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0);
...
defineSeed(1977, 668, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$4X_0);
...
;
_.val$bulletin = null;
var Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter', 877), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$1', 878), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$2', 886), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$3', 887), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$4', 888), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$5', 889), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$6', 890), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$7', 891), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$8', 892), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$9', 893), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$10', 879), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$11_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$11', 880), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$12_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$12', 881), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$13_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$13', 882), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$14_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$14', 883), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$16_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$16', 885), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView', 1498), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$1', 1499), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$2', 1506), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$3', 1507), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$4', 1508), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$5', 1509), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$6', 1510), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$7', 1511), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$8', 1512), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$9_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$9', 1513), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$10_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$10', 1500), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$11_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$11', 1501), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$12_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$12', 1502), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$13_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$13', 1503), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$14_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$14', 1504), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$15_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$15', 1505), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl', 1514), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets', 1515), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$1', 1516), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$2', 1517), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$3', 1518), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$4', 1519), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$5', 1520), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$6', 1521), Lcom_lemania_eprospects_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$4X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$4X', 1977), Lcom_lemania_eprospects_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X', 1884), Lcom_lemania_eprospects_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X', 1881), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X', 1864), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X', 1860);
$entry(onLoad)(17);
