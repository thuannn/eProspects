...
defineSeed(791, 236, {}, BrancheNameAfterChangeEvent_0);
...
defineSeed(851, 724, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheListPresenter, Q$FrmBrancheListUiHandler]), FrmBrancheListPresenter_0);
...
defineSeed(852, 664, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$1_0);
...
defineSeed(853, 664, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$2_0);
...
defineSeed(854, 664, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$3_0);
...
;
defineSeed(855, 756, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(858, 738, {}, FrmBrancheListPresenterMyProxyImpl$2_0);
...
defineSeed(859, 1, {}, FrmBrancheListPresenterMyProxyImpl$2$1_0);
...
defineSeed(1469, 729, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1470, 381, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
...
defineSeed(1471, 1, {}, FrmBrancheListView$2_0);
...
defineSeed(1472, 381, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
...
defineSeed(1473, 1, {}, FrmBrancheListView$4_0);
...
defineSeed(1474, 381, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
...
defineSeed(1475, 1, {}, FrmBrancheListView$6_0);
...
defineSeed(1476, 1, {}, FrmBrancheListView_BinderImpl_0);
...
defineSeed(1477, 1, {}, FrmBrancheListView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1856, 668, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
...
defineSeed(1863, 668, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0);
...
var Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter', 851), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter$1', 852), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter$2', 853), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenter$3', 854), Lcom_lemania_eprospects_client_event_BrancheNameAfterChangeEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'BrancheNameAfterChangeEvent', 791), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2', 858), Lcom_lemania_eprospects_client_presenter_FrmBrancheListPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2$1', 859), Lcom_lemania_eprospects_client_view_FrmBrancheListView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView', 1469), Lcom_lemania_eprospects_client_view_FrmBrancheListView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$1', 1470), Lcom_lemania_eprospects_client_view_FrmBrancheListView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$2', 1471), Lcom_lemania_eprospects_client_view_FrmBrancheListView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$3', 1472), Lcom_lemania_eprospects_client_view_FrmBrancheListView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$4', 1473), Lcom_lemania_eprospects_client_view_FrmBrancheListView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$5', 1474), Lcom_lemania_eprospects_client_view_FrmBrancheListView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView$6', 1475), Lcom_lemania_eprospects_client_view_FrmBrancheListView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView_BinderImpl', 1476), Lcom_lemania_eprospects_client_view_FrmBrancheListView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheListView_BinderImpl$Widgets', 1477), Lcom_lemania_eprospects_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$5X', 1856), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X', 1863);
$entry(onLoad)(15);
