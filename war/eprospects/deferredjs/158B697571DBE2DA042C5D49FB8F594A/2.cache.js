...
defineSeed(771, 235, {}, ApplicationStartEvent_0);
...
defineSeed(1111, 715, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationHomeUiHandlers]), ApplicationHomePresenter_0);
...
defineSeed(1112, 655, makeCastMap([Q$Receiver]), ApplicationHomePresenter$1_0);
...
defineSeed(1113, 655, makeCastMap([Q$Receiver]), ApplicationHomePresenter$2_0);
...
defineSeed(1114, 655, makeCastMap([Q$Receiver]), ApplicationHomePresenter$3_0);
...
defineSeed(1117, 720, makeCastMap([Q$IsWidget, Q$ApplicationHomePresenter$MyView, Q$ApplicationHomeView]), ApplicationHomeView_0);
...
defineSeed(1118, 1, {}, ApplicationHomeView_BinderImpl_0);
...
defineSeed(1119, 1, {}, ApplicationHomeView_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationHomeView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1120, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationHomeView_BinderImpl$Widgets$1_0);
...
defineSeed(1288, 728, {}, MainPagePresenterMyProxyImpl$6_0);
...
defineSeed(1289, 1, {}, MainPagePresenterMyProxyImpl$6$1_0);
...
defineSeed(1698, 659, makeCastMap([Q$AbstractRequest]), ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$1X_0);
...
defineSeed(1700, 659, makeCastMap([Q$AbstractRequest]), ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$7X_0);
...
;
_.val$emailAddress = null;
var Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter', 1111), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter$1', 1112), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter$2', 1113), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter$3', 1114), Lcom_lemania_eprospects_client_event_ApplicationStartEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStartEvent', 771), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$6', 1288), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$6$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$6$1', 1289), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView', 1117), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl', 1118), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl$Widgets', 1119), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl$Widgets$1', 1120), Lcom_lemania_eprospects_shared_service_ApplicationFormRequestFactory_1ApplicationFormRequestContextImpl$1X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$1X', 1698), Lcom_lemania_eprospects_shared_service_ApplicationFormRequestFactory_1ApplicationFormRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$7X', 1700);
$entry(onLoad)(2);
