...
function $onBulletinSelected(this$static, bulletin){
  ...
  $initialize_0(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl_0(rf);
  $fire($listAll_2(rc, '' + toString_6(bulletin.getId_0().value_0)), new FrmBulletinManagementPresenter$7_0(this$static, bulletin));
}
...
function $onSubjectSelected(this$static, subject){
  ...
  $initialize_0(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl_0(rf);
  $fire($listAll_1(rc, '' + toString_6(subject.getId_0().value_0)), new FrmBulletinManagementPresenter$9_0(this$static));
}
...
defineSeed(851, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$1_0);
...
defineSeed(852, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$10_0);
...
defineSeed(853, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$11_0);
...
defineSeed(854, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$12_0);
...
defineSeed(855, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$13_0);
...
defineSeed(856, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$14_0);
...
defineSeed(858, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$16_0);
...
defineSeed(859, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$2_0);
...
defineSeed(860, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$3_0);
...
defineSeed(861, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$4_0);
...
defineSeed(862, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$5_0);
...
defineSeed(863, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$6_0);
...
defineSeed(864, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$7_0);
...
defineSeed(865, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$8_0);
...
defineSeed(866, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$9_0);
...
function $onCmdAddBrancheClick(this$static){
  !!this$static.uiHandlers && $addBranche(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), '' + toString_6(this$static.selectedSubject.getId_0().value_0), $getValue_1(this$static.lstBranches, this$static.lstBranches.element.selectedIndex), $getPropertyString(this$static.txtBrancheCoef.element, 'value'));
}
...
defineSeed(1325, 703, makeCastMap([Q$IsWidget, Q$FrmBulletinManagementPresenter$MyView]), FrmBulletinManagementView_0);
...
defineSeed(1326, 389, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$1_0);
...
defineSeed(1327, 389, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$10_0);
...
defineSeed(1328, 363, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$11_0);
...
defineSeed(1329, 1, {}, FrmBulletinManagementView$12_0);
...
defineSeed(1330, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$13_0);
...
defineSeed(1331, 389, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$14_0);
...
defineSeed(1332, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$15_0);
...
defineSeed(1333, 363, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$2_0);
...
defineSeed(1334, 1, {}, FrmBulletinManagementView$3_0);
...
defineSeed(1335, 363, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$4_0);
...
defineSeed(1336, 1, {}, FrmBulletinManagementView$5_0);
...
defineSeed(1337, 389, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$6_0);
...
defineSeed(1338, 363, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$7_0);
...
defineSeed(1339, 1, {}, FrmBulletinManagementView$8_0);
...
defineSeed(1340, 389, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$9_0);
...
defineSeed(1341, 1, {}, FrmBulletinManagementView_BinderImpl_0);
...
defineSeed(1342, 1, {}, FrmBulletinManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1343, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1344, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1345, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$3_0);
...
defineSeed(1346, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$4_0);
...
defineSeed(1347, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$5_0);
...
defineSeed(1348, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$6_0);
...
defineSeed(1598, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1599, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
_.setBrancheCoef = function setBrancheCoef_0(brancheCoef){
  $setProperty(this.this$0, 'brancheCoef', brancheCoef);
}
;
defineSeed(1604, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
;
defineSeed(1605, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
defineSeed(1664, 641, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0);
...
defineSeed(1668, 641, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0);
...
defineSeed(1685, 641, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0);
...
defineSeed(1688, 641, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0);
...
defineSeed(1780, 641, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$4X_0);
...
;
_.val$bulletin = null;
var Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter', 850), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$1', 851), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$2', 859), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$3', 860), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$4', 861), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$5', 862), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$6', 863), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$7', 864), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$8', 865), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$9', 866), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$10', 852), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$11_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$11', 853), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$12_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$12', 854), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$13_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$13', 855), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$14_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$14', 856), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$16_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$16', 858), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView', 1325), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$1', 1326), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$2', 1333), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$3', 1334), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$4', 1335), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$5', 1336), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$6', 1337), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$7', 1338), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$8', 1339), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$9_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$9', 1340), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$10_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$10', 1327), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$11_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$11', 1328), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$12_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$12', 1329), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$13_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$13', 1330), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$14_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$14', 1331), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$15_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$15', 1332), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl', 1341), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets', 1342), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$1', 1343), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$2', 1344), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$3', 1345), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$4', 1346), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$5', 1347), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$6', 1348), Lcom_lemania_eprospects_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$4X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$4X', 1780), Lcom_lemania_eprospects_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X', 1688), Lcom_lemania_eprospects_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X', 1685), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X', 1668), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X', 1664);
$entry(onLoad)(17);
