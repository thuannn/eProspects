...
defineSeed(772, 234, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(856, 636, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
defineSeed(1056, 636, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1057, 636, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1058, 636, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1059, 636, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1060, 636, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1072, 636, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1564, 702, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1565, 362, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1566, 1, {}, StudentView$2_0);
...
defineSeed(1567, 362, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1568, 1, {}, StudentView$4_0);
...
defineSeed(1569, 362, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1570, 1, {}, StudentView$6_0);
...
defineSeed(1571, 362, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1572, 1, {}, StudentView$8_0);
...
defineSeed(1573, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1574, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1645, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1680, 640, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1776, 640, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1778, 640, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1792, 640, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
