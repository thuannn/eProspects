...
defineSeed(460, 427, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
defineSeed(464, 460, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
function $onBulletinChange(this$static, bulletinId){
  ...
  $fire($listAll_3(rc, bulletinId), new FrmBulletinViewDetailPresenter$4_0(this$static, bulletinId));
}
...
defineSeed(889, 713, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
_.onReset = function onReset_8(){
  ...
  this.currentUser.isStudent && ($showAdminPanel(dynamicCast(this.view, Q$FrmBulletinViewDetailPresenter$MyView), ($clinit_Boolean() , $clinit_Boolean() , FALSE_1)) , rf = new BulletinRequestFactoryImpl_0 , $initialize_0(rf, this.eventBus, new EventSourceRequestTransport_0(this.eventBus)) , rc = new BulletinRequestFactory_BulletinRequestContextImpl_0(rf) , $fire($listAllByEmail(rc, this.currentUser.userEmail), new FrmBulletinViewDetailPresenter$2_0(this)) , undefined);
}
;
...
defineSeed(890, 653, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
defineSeed(891, 653, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(892, 653, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(893, 653, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(894, 653, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
defineSeed(895, 653, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
...
_.onSuccess = function onSuccess_192(){
...
function $onLstBulletinsChange(this$static){
  $removeAllRows(this$static.tblBulletin);
  !!this$static.uiHandlers && $onBulletinChange(dynamicCast(this$static.uiHandlers, Q$FrmBulletinViewDetailUiHandler), $getValue_2(this$static.lstBulletins, this$static.lstBulletins.element.selectedIndex));
}

function $onLstClassesChange_1(this$static){
  !!this$static.uiHandlers && $onClassChange_0(dynamicCast(this$static.uiHandlers, Q$FrmBulletinViewDetailUiHandler), $getValue_2(this$static.lstClasses, this$static.lstClasses.element.selectedIndex));
}
...
function $styleTableMatu(this$static){
  ...
  $setCellPadding(this$static.tblBulletin, 3);
...
defineSeed(1512, 718, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1513, 1, {}, FrmBulletinViewDetailView_BinderImpl_0);
...
defineSeed(1514, 1, {}, FrmBulletinViewDetailView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1515, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$1_0);
...
defineSeed(1516, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$2_0);
...
defineSeed(1851, 657, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
defineSeed(1862, 657, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
...
defineSeed(1865, 657, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$8X_0);
...
;
_.val$email = null;
var Lcom_lemania_eprospects_client_presenter_FrmBulletinViewDetailPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewDetailPresenter', 889), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewDetailPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewDetailPresenter$1', 890), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewDetailPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewDetailPresenter$2', 891), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewDetailPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewDetailPresenter$3', 892), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewDetailPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewDetailPresenter$4', 893), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewDetailPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewDetailPresenter$5', 894), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewDetailPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewDetailPresenter$6', 895), Lcom_lemania_eprospects_client_view_FrmBulletinViewDetailView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewDetailView', 1512), Lcom_lemania_eprospects_client_view_FrmBulletinViewDetailView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewDetailView_BinderImpl', 1513), Lcom_lemania_eprospects_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets', 1514), Lcom_lemania_eprospects_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$1', 1515), Lcom_lemania_eprospects_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$2', 1516), Lcom_lemania_eprospects_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$2X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$2X', 1862), Lcom_lemania_eprospects_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$8X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$8X', 1865), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X', 1851);
$entry(onLoad)(18);
