function $onBulletinChange_0(this$static, bulletinId){
  ...
  $fire($listAll_3(rc, bulletinId), new FrmBulletinViewSummaryPresenter$3_0(this$static));
}
...
defineSeed(900, 713, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewSummaryPresenter, Q$FrmBulletinViewSummaryUiHandler]), FrmBulletinViewSummaryPresenter_0);
...
defineSeed(901, 653, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$1_0);
...
defineSeed(902, 653, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$2_0);
...
defineSeed(903, 653, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$3_0);
...
defineSeed(904, 653, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$4_0);
...
function $styleBacTable(this$static){
  ...
  $setCellPadding(this$static.tblNotes, 3);
...
defineSeed(1518, 718, makeCastMap([Q$IsWidget, Q$FrmBulletinViewSummaryPresenter$MyView]), FrmBulletinViewSummaryView_0);
...
defineSeed(1519, 511, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), FrmBulletinViewSummaryView$1_0);
...
defineSeed(1520, 1, makeCastMap([Q$CloseHandler, Q$EventHandler]), FrmBulletinViewSummaryView$2_0);
...
defineSeed(1521, 1, {}, FrmBulletinViewSummaryView_BinderImpl_0);
...
defineSeed(1522, 1, {}, FrmBulletinViewSummaryView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1523, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$1_0);
...
defineSeed(1524, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$2_0);
...
defineSeed(1525, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$3_0);
...
defineSeed(1526, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$4_0);
...
defineSeed(1527, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$5_0);
...
defineSeed(1859, 657, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$12X_0);
...
var Lcom_lemania_eprospects_client_presenter_FrmBulletinViewSummaryPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewSummaryPresenter', 900), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewSummaryPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewSummaryPresenter$1', 901), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewSummaryPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewSummaryPresenter$2', 902), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewSummaryPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewSummaryPresenter$3', 903), Lcom_lemania_eprospects_client_presenter_FrmBulletinViewSummaryPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinViewSummaryPresenter$4', 904), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView', 1518), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView$1', 1519), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView$2', 1520), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView_BinderImpl', 1521), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets', 1522), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$1', 1523), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$2', 1524), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$3', 1525), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$4', 1526), Lcom_lemania_eprospects_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$5', 1527), Lcom_lemania_eprospects_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$12X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$12X', 1859);
$entry(onLoad)(19);
