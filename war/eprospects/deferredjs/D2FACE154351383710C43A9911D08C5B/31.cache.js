...
defineSeed(1015, 688, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1016, 627, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1017, 627, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1018, 627, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1019, 627, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1020, 627, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1021, 627, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1022, 627, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1023, 627, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1024, 627, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1522, 693, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1523, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1524, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1525, 1, {}, ProfsView$3_0);
...
defineSeed(1526, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), ProfsView$4_0);
...
defineSeed(1527, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1528, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1529, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1530, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1531, 1, {}, ProfsView$9_0);
...
defineSeed(1532, 1, {}, ProfsView_BinderImpl_0);
...
defineSeed(1533, 1, {}, ProfsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1534, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$1_0);
...
defineSeed(1535, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$2_0);
...
defineSeed(1536, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$3_0);
...
defineSeed(1537, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$4_0);
...
defineSeed(1588, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
_.setActive = function setActive(active){
  dynamicCast($getWrapped(this.this$0), Q$AssignmentProxy).setActive(active);
}
;
defineSeed(1589, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
...
defineSeed(1646, 631, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1647, 631, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1648, 631, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1738, 631, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
...
;
_.val$newProf = null;
var Lcom_lemania_eprospects_client_presenter_ProfsPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter', 1015), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$1', 1016), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$2', 1018), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$3', 1019), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$5', 1020), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$6', 1021), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$7', 1022), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$8', 1023), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$9', 1024), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$10', 1017), Lcom_lemania_eprospects_client_view_ProfsView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView', 1522), Lcom_lemania_eprospects_client_view_ProfsView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$1', 1523), Lcom_lemania_eprospects_client_view_ProfsView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$2', 1524), Lcom_lemania_eprospects_client_view_ProfsView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$3', 1525), Lcom_lemania_eprospects_client_view_ProfsView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$4', 1526), Lcom_lemania_eprospects_client_view_ProfsView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$5', 1527), Lcom_lemania_eprospects_client_view_ProfsView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$6', 1528), Lcom_lemania_eprospects_client_view_ProfsView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$7', 1529), Lcom_lemania_eprospects_client_view_ProfsView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$8', 1530), Lcom_lemania_eprospects_client_view_ProfsView$9_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$9', 1531), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl', 1532), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets', 1533), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$1', 1534), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$2', 1535), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$3', 1536), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$4', 1537), Lcom_lemania_eprospects_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$6X', 1738), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$3X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$3X', 1648), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$10X', 1646), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$11X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$11X', 1647);
$entry(onLoad)(31);
