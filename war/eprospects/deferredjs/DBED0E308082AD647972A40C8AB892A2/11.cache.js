...
defineSeed(797, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(798, 642, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(799, 642, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(800, 642, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(801, 642, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1299, 707, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1300, 368, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1301, 1, {}, CoursView$2_0);
...
defineSeed(1302, 368, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1303, 1, {}, CoursView$4_0);
...
defineSeed(1304, 1, {}, CoursView_BinderImpl_0);
...
defineSeed(1305, 1, {}, CoursView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1306, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), CoursView_BinderImpl$Widgets$1_0);
...
defineSeed(1751, 646, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
...
;
_.val$newCours = null;
var Lcom_lemania_eprospects_client_presenter_CoursPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter', 797), Lcom_lemania_eprospects_client_presenter_CoursPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$1', 798), Lcom_lemania_eprospects_client_presenter_CoursPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$2', 799), Lcom_lemania_eprospects_client_presenter_CoursPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$3', 800), Lcom_lemania_eprospects_client_presenter_CoursPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$4', 801), Lcom_lemania_eprospects_client_view_CoursView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView', 1299), Lcom_lemania_eprospects_client_view_CoursView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$1', 1300), Lcom_lemania_eprospects_client_view_CoursView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$2', 1301), Lcom_lemania_eprospects_client_view_CoursView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$3', 1302), Lcom_lemania_eprospects_client_view_CoursView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$4', 1303), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl', 1304), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl$Widgets', 1305), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl$Widgets$1', 1306), Lcom_lemania_eprospects_shared_service_CoursRequestFactory_1CoursRequestContextImpl$8X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$8X', 1751);
$entry(onLoad)(11);
