...
defineSeed(1035, 708, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1036, 648, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1037, 648, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1038, 648, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1039, 648, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1040, 648, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1041, 648, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1042, 648, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1043, 648, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1044, 648, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1214, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1543, 713, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1544, 398, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1545, 372, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1546, 1, {}, ProfsView$3_0);
...
defineSeed(1547, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), ProfsView$4_0);
...
defineSeed(1548, 398, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1549, 398, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1550, 398, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1551, 372, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1552, 1, {}, ProfsView$9_0);
...
defineSeed(1553, 1, {}, ProfsView_BinderImpl_0);
...
defineSeed(1554, 1, {}, ProfsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1555, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$1_0);
...
defineSeed(1556, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$2_0);
...
defineSeed(1557, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$3_0);
...
defineSeed(1558, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$4_0);
...
defineSeed(1609, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
_.setActive = function setActive(active){
  dynamicCast($getWrapped(this.this$0), Q$AssignmentProxy).setActive(active);
}
;
defineSeed(1610, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
...
defineSeed(1667, 652, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1668, 652, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1669, 652, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1759, 652, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
...
;
_.val$newProf = null;
var Lcom_lemania_eprospects_client_presenter_ProfsPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter', 1035), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$1', 1036), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$2', 1038), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$3', 1039), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$5', 1040), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$6', 1041), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$7', 1042), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$8', 1043), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$9', 1044), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$10', 1037), Lcom_lemania_eprospects_client_view_ProfsView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView', 1543), Lcom_lemania_eprospects_client_view_ProfsView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$1', 1544), Lcom_lemania_eprospects_client_view_ProfsView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$2', 1545), Lcom_lemania_eprospects_client_view_ProfsView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$3', 1546), Lcom_lemania_eprospects_client_view_ProfsView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$4', 1547), Lcom_lemania_eprospects_client_view_ProfsView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$5', 1548), Lcom_lemania_eprospects_client_view_ProfsView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$6', 1549), Lcom_lemania_eprospects_client_view_ProfsView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$7', 1550), Lcom_lemania_eprospects_client_view_ProfsView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$8', 1551), Lcom_lemania_eprospects_client_view_ProfsView$9_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$9', 1552), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl', 1553), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets', 1554), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$1', 1555), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$2', 1556), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$3', 1557), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$4', 1558), Lcom_lemania_eprospects_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$6X', 1759), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$3X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$3X', 1669), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$10X', 1667), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$11X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$11X', 1668);
$entry(onLoad)(31);
