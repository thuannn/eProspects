...
defineSeed(288, 283, {}, DateTimeFormatInfoImpl_0);
...
defineSeed(289, 1, makeCastMap([Q$DateTimeFormat]), DateTimeFormat_0);
_.pattern = null;
var cache = null;
...
defineSeed(290, 1, makeCastMap([Q$DateTimeFormat$PatternPart]), DateTimeFormat$PatternPart_0);
_.abutStart = false;
_.count = 0;
_.text_0 = null;
...
defineSeed(292, 1, makeCastMap([Q$Serializable, Q$Comparable, Q$Date]), Date_1, Date_2);
...
defineSeed(291, 292, makeCastMap([Q$Serializable, Q$Comparable, Q$Date]), DateRecord_0);
...
defineSeed(675, 292, makeCastMap([Q$Poser, Q$DatePoser, Q$Serializable, Q$Comparable, Q$Date]));
...
defineSeed(766, 235, {}, ApplicationStep2CompletedEvent_0);
...
defineSeed(1137, 708, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationStep2Presenter, Q$ApplicationStep2UiHandlers]), ApplicationStep2Presenter_0);
...
function $initializeUI(this$static){
  ...
  maxWeek = 8;
  $insertItem(this$static.lstStartDate, 'Veuillez choisir', '0', -1);
...
defineSeed(1140, 713, makeCastMap([Q$IsWidget, Q$ApplicationStep2Presenter$MyView]), ApplicationStep2View_0);
...
defineSeed(1141, 1, {}, ApplicationStep2View_BinderImpl_0);
function $build_main_3(this$static){
  var main, f_VerticalPanel1, f_Label2, f_Label3, f_FlowPanel4, f_HorizontalPanel5, f_VerticalPanel45, f_VerticalPanel6, f_Label7, f_CheckBox8, f_CheckBox9, f_Label10, f_Grid11, f_Label12, lstStartDate, f_Label13, f_Label14, lstWeekNumber, f_Label15, f_Label16, f_Label17, f_Label18, f_Label19, txtJulyWeek, txtAgustWeek, f_Label20, f_CheckBox21, f_Label22, f_Label23, f_Grid24, f_Label25, optConfortPlus, f_RadioButton26, f_RadioButton27, f_Label28, f_RadioButton29, f_RadioButton30, f_RadioButton31, f_Label32, f_Label33, f_Label34, f_Label35, f_Grid36, f_Label37, f_RadioButton38, f_RadioButton39, f_RadioButton40, f_VerticalPanel41, f_Label42, f_FlexTable43, f_Label44, f_HorizontalPanel46, f_Button47, sb, cmdNextStep, sb_0;
  main = new SimplePanel_0;
  $add_4(main, (f_VerticalPanel1 = new VerticalPanel_0 , $setHorizontalAlignment_1(f_VerticalPanel1, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $add_11(f_VerticalPanel1, (f_Label2 = new Label_0 , f_Label2.element['className'] = 'pageTitle' , $setTextOrHtml(f_Label2.directionalTextHelper, 'CHOIX DU PROGRAMME', false) , $updateHorizontalAlignment(f_Label2) , f_Label2)) , $add_11(f_VerticalPanel1, (f_Label3 = new Label_0 , $setTextOrHtml(f_Label3.directionalTextHelper, 'Step 2 of 5', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_11(f_VerticalPanel1, (f_FlowPanel4 = new FlowPanel_0 , $add_7(f_FlowPanel4, (f_HorizontalPanel5 = new HorizontalPanel_0 , $add_9(f_HorizontalPanel5, (f_VerticalPanel6 = new VerticalPanel_0 , $add_11(f_VerticalPanel6, (f_Label7 = new Label_0 , f_Label7.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label7.directionalTextHelper, 'PROGRAMMES', false) , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $add_11(f_VerticalPanel6, (f_CheckBox8 = new CheckBox_0 , f_CheckBox8.inputElem.disabled = true , $setStyleName_0(f_CheckBox8, getStylePrimaryName(f_CheckBox8.element) + '-disabled') , $setTextOrHtml(f_CheckBox8.directionalTextHelper, "Frais d'inscription, CHF 100.-", false) , $setValue_1(f_CheckBox8, ($clinit_Boolean() , $clinit_Boolean() , TRUE_1)) , f_CheckBox8)) , $add_11(f_VerticalPanel6, (f_CheckBox9 = new CheckBox_0 , $setTextOrHtml(f_CheckBox9.directionalTextHelper, 'Pack Assurance sant\xE9 CHF 190.- (obligatoire pour les internes sauf les r\xE9sidents en Suisse)', false) , f_CheckBox9)) , $add_11(f_VerticalPanel6, (f_Label10 = new Label_0 , f_Label10.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label10.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label10) , f_Label10)) , $add_11(f_VerticalPanel6, (f_Grid11 = new Grid_0 , $resizeColumns(f_Grid11, 3) , $resizeRows(f_Grid11, 5) , $setWidget_1(f_Grid11, 0, 0, (f_Label12 = new Label_0 , $setTextOrHtml(f_Label12.directionalTextHelper, 'Date de d\xE9but', false) , $updateHorizontalAlignment(f_Label12) , f_Label12)) , $setWidget_1(f_Grid11, 0, 1, (lstStartDate = new ListBox_0 , $addDomHandler(lstStartDate, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstStartDate = lstStartDate , lstStartDate)) , $setWidget_1(f_Grid11, 0, 2, (f_Label13 = new Label_0 , $setTextOrHtml(f_Label13.directionalTextHelper, '(dd/MM/yyyy)', false) , $updateHorizontalAlignment(f_Label13) , f_Label13)) , $setWidget_1(f_Grid11, 1, 0, (f_Label14 = new Label_0 , $setTextOrHtml(f_Label14.directionalTextHelper, 'Nombre de semaines', false) , $updateHorizontalAlignment(f_Label14) , f_Label14)) , $setWidget_1(f_Grid11, 1, 1, (lstWeekNumber = new ListBox_0 , this$static.owner.lstWeekNumber = lstWeekNumber , lstWeekNumber)) , $setWidget_1(f_Grid11, 1, 2, (f_Label15 = new Label_0 , $setTextOrHtml(f_Label15.directionalTextHelper, 'Nous vous recommandons \xE0 choisir au moins 2 semaines.', false) , $updateHorizontalAlignment(f_Label15) , f_Label15)) , $setWidget_1(f_Grid11, 2, 0, (f_Label16 = new Label_0 , $setTextOrHtml(f_Label16.directionalTextHelper, 'La dur\xE9e choisie en d\xE9tail', false) , $updateHorizontalAlignment(f_Label16) , f_Label16)) , $setWidget_1(f_Grid11, 2, 1, (f_Label17 = new Label_0 , $setTextOrHtml(f_Label17.directionalTextHelper, 'Juillet', false) , $updateHorizontalAlignment(f_Label17) , f_Label17)) , $setWidget_1(f_Grid11, 2, 2, (f_Label18 = new Label_0 , $setTextOrHtml(f_Label18.directionalTextHelper, 'Ao\xFBt', false) , $updateHorizontalAlignment(f_Label18) , f_Label18)) , $setWidget_1(f_Grid11, 3, 0, (f_Label19 = new Label_0 , f_Label19.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label19.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label19) , f_Label19)) , $setWidget_1(f_Grid11, 3, 1, (txtJulyWeek = new TextBox_0 , txtJulyWeek.element['className'] = 'sis_textbox_readonly' , txtJulyWeek.element.style['width'] = '100px' , txtJulyWeek)) , $setWidget_1(f_Grid11, 3, 2, (txtAgustWeek = new TextBox_0 , txtAgustWeek.element['className'] = 'sis_textbox_readonly' , txtAgustWeek.element.style['width'] = '100px' , txtAgustWeek)) , $setWidget_1(f_Grid11, 4, 0, (f_Label20 = new Label_0 , $setTextOrHtml(f_Label20.directionalTextHelper, 'Programme', false) , $updateHorizontalAlignment(f_Label20) , f_Label20)) , $setWidget_1(f_Grid11, 4, 1, new ListBox_0) , f_Grid11.element.style['width'] = '100%' , f_Grid11.tableElem['cellSpacing'] = 2 , f_Grid11.tableElem['cellPadding'] = 2 , f_Grid11)) , $add_11(f_VerticalPanel6, (f_CheckBox21 = new CheckBox_0 , $setTextOrHtml(f_CheckBox21.directionalTextHelper, "Souhaitez-vous continuer le programme choisi apr\xE8s le cours d'\xE9t\xE9 ?", false) , f_CheckBox21)) , $add_11(f_VerticalPanel6, (f_Label22 = new Label_0 , f_Label22.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label22.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label22) , f_Label22)) , $add_11(f_VerticalPanel6, (f_Label23 = new Label_0 , f_Label23.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label23.directionalTextHelper, 'Logement - Internat', false) , $updateHorizontalAlignment(f_Label23) , f_Label23)) , $add_11(f_VerticalPanel6, (f_Grid24 = new Grid_0 , $resizeColumns(f_Grid24, 4) , $resizeRows(f_Grid24, 2) , $setWidget_1(f_Grid24, 0, 0, (f_Label25 = new Label_0 , $setTextOrHtml(f_Label25.directionalTextHelper, 'Chambre priv\xE9e', false) , $updateHorizontalAlignment(f_Label25) , f_Label25)) , $setWidget_1(f_Grid24, 0, 1, (optConfortPlus = new RadioButton_0 , $setTextOrHtml(optConfortPlus.directionalTextHelper, 'Confort plus', false) , optConfortPlus)) , $setWidget_1(f_Grid24, 0, 2, (f_RadioButton26 = new RadioButton_0 , $setTextOrHtml(f_RadioButton26.directionalTextHelper, 'Confort', false) , f_RadioButton26)) , $setWidget_1(f_Grid24, 0, 3, (f_RadioButton27 = new RadioButton_0 , $setTextOrHtml(f_RadioButton27.directionalTextHelper, 'Standard', false) , f_RadioButton27)) , $setWidget_1(f_Grid24, 1, 0, (f_Label28 = new Label_0 , $setTextOrHtml(f_Label28.directionalTextHelper, 'Chambre \xE0 partager (Deux lits jumeaux)', false) , $updateHorizontalAlignment(f_Label28) , f_Label28)) , $setWidget_1(f_Grid24, 1, 1, (f_RadioButton29 = new RadioButton_0 , $setTextOrHtml(f_RadioButton29.directionalTextHelper, 'Confort plus', false) , f_RadioButton29)) , $setWidget_1(f_Grid24, 1, 2, (f_RadioButton30 = new RadioButton_0 , $setTextOrHtml(f_RadioButton30.directionalTextHelper, 'Confort', false) , f_RadioButton30)) , $setWidget_1(f_Grid24, 1, 3, (f_RadioButton31 = new RadioButton_0 , $setTextOrHtml(f_RadioButton31.directionalTextHelper, 'Standard', false) , f_RadioButton31)) , f_Grid24.element.style['width'] = '100%' , f_Grid24)) , $add_11(f_VerticalPanel6, (f_Label32 = new Label_0 , $setTextOrHtml(f_Label32.directionalTextHelper, "Le nombre de places \xE0 l'internat \xE9tant limit\xE9, une r\xE9servation en avance est recommand\xE9e.\nLes \xE9tudiants doivent arriver le dimanche apr\xE8s-midi et partir le samedi matin.", false) , $updateHorizontalAlignment(f_Label32) , f_Label32)) , $add_11(f_VerticalPanel6, (f_Label33 = new Label_0 , f_Label33.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label33.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label33) , f_Label33)) , $add_11(f_VerticalPanel6, (f_Label34 = new Label_0 , f_Label34.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label34.directionalTextHelper, 'D\xE9p\xF4t pour la cl\xE9', false) , $updateHorizontalAlignment(f_Label34) , f_Label34)) , $add_11(f_VerticalPanel6, (f_Label35 = new Label_0 , $setTextOrHtml(f_Label35.directionalTextHelper, 'Afin de recevoir la cl\xE9 de la chambre, les \xE9tudiants doivent effectuer un d\xE9p\xF4t \xE0 leur arriv\xE9e.\nCe montant leur sera restitu\xE9 \xE0 leur d\xE9part avec le retour de la cl\xE9. Il sera conserv\xE9 en cas de perte de la cl\xE9.', false) , $updateHorizontalAlignment(f_Label35) , f_Label35)) , $add_11(f_VerticalPanel6, (f_Grid36 = new Grid_0 , $resizeColumns(f_Grid36, 4) , $resizeRows(f_Grid36, 1) , $setWidget_1(f_Grid36, 0, 0, (f_Label37 = new Label_0 , $setTextOrHtml(f_Label37.directionalTextHelper, 'Choix de la monnaie du d\xE9p\xF4t', false) , $updateHorizontalAlignment(f_Label37) , f_Label37)) , $setWidget_1(f_Grid36, 0, 1, (f_RadioButton38 = new RadioButton_0 , $setTextOrHtml(f_RadioButton38.directionalTextHelper, 'CHF 100.-', false) , f_RadioButton38)) , $setWidget_1(f_Grid36, 0, 2, (f_RadioButton39 = new RadioButton_0 , $setTextOrHtml(f_RadioButton39.directionalTextHelper, '\u20AC 100.-', false) , f_RadioButton39)) , $setWidget_1(f_Grid36, 0, 3, (f_RadioButton40 = new RadioButton_0 , $setTextOrHtml(f_RadioButton40.directionalTextHelper, 'US$ 100.-', false) , f_RadioButton40)) , f_Grid36.element.style['width'] = '100%' , f_Grid36)) , f_VerticalPanel6.element.style['width'] = '100%' , f_VerticalPanel6)) , $add_9(f_HorizontalPanel5, (f_VerticalPanel41 = new VerticalPanel_0 , $add_11(f_VerticalPanel41, (f_Label42 = new Label_0 , f_Label42.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label42.directionalTextHelper, 'ELEMENTS CHOISIS', false) , $updateHorizontalAlignment(f_Label42) , f_Label42)) , $add_11(f_VerticalPanel41, (f_FlexTable43 = new FlexTable_0 , f_FlexTable43.element.style['width'] = '100%' , f_FlexTable43)) , $add_11(f_VerticalPanel41, (f_Label44 = new Label_0 , $setTextOrHtml(f_Label44.directionalTextHelper, 'Total', false) , $updateHorizontalAlignment(f_Label44) , f_Label44)) , f_VerticalPanel41.element['className'] = 'subSection' , f_VerticalPanel41.element.style['width'] = '250px' , f_VerticalPanel41)) , f_HorizontalPanel5.element.style['width'] = '100%' , f_HorizontalPanel5.table['cellSpacing'] = 10 , f_HorizontalPanel5)) , $add_7(f_FlowPanel4, (f_VerticalPanel45 = new VerticalPanel_0 , $setHorizontalAlignment_1(f_VerticalPanel45, ALIGN_RIGHT) , $add_11(f_VerticalPanel45, (f_HorizontalPanel46 = new HorizontalPanel_0 , $setHorizontalAlignment_0(f_HorizontalPanel46, ALIGN_RIGHT) , $add_9(f_HorizontalPanel46, (f_Button47 = new Button_0 , $setHTML(f_Button47, (sb = new StringBuilder_0 , $append_1(sb.data, 'Pr\xE9c\xE9dant') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb.data))).html) , f_Button47)) , $add_9(f_HorizontalPanel46, (cmdNextStep = new Button_0 , $setHTML(cmdNextStep, (sb_0 = new StringBuilder_0 , $append_1(sb_0.data, 'Next Step') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data))).html) , $setInnerText(cmdNextStep.element, 'Suivant') , $addDomHandler(cmdNextStep, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdNextStep)) , f_HorizontalPanel46.element.style['width'] = '20%' , f_HorizontalPanel46.table['cellSpacing'] = 10 , f_HorizontalPanel46)) , f_VerticalPanel45.element.style['width'] = '100%' , f_VerticalPanel45)) , f_FlowPanel4.element.style['width'] = '900px' , f_FlowPanel4)) , f_VerticalPanel1.element.style['height'] = '' , f_VerticalPanel1.element.style['width'] = '100%' , f_VerticalPanel1));
...
defineSeed(1142, 1, {}, ApplicationStep2View_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationStep2View_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1143, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$1_0);
...
defineSeed(1144, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ApplicationStep2View_BinderImpl$Widgets$2_0);
...
defineSeed(1148, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1264, 721, {}, MainPagePresenterMyProxyImpl$8_0);
...
defineSeed(1265, 1, {}, MainPagePresenterMyProxyImpl$8$1_0);
...
defineSeed(1855, 1, makeCastMap([Q$CharSequence]), StringBuffer_1);
var Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2Presenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2Presenter', 1137), Lcom_lemania_eprospects_client_event_ApplicationStep2CompletedEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStep2CompletedEvent', 766), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$8', 1264), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$8$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$8$1', 1265), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View', 1140), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl', 1141), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets', 1142), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$1', 1143), Lcom_lemania_eprospects_client_presenter_applicationstep2_ApplicationStep2View_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep2.', 'ApplicationStep2View_BinderImpl$Widgets$2', 1144), Lcom_google_gwt_i18n_shared_DateTimeFormat_2_classLit = createForClass('com.google.gwt.i18n.shared.', 'DateTimeFormat', 289), Lcom_google_gwt_i18n_shared_DateTimeFormat$PatternPart_2_classLit = createForClass('com.google.gwt.i18n.shared.', 'DateTimeFormat$PatternPart', 290), Lcom_google_gwt_i18n_shared_impl_DateRecord_2_classLit = createForClass('com.google.gwt.i18n.shared.impl.', 'DateRecord', 291), Lcom_google_gwt_i18n_client_TimeZone_2_classLit = createForClass('com.google.gwt.i18n.client.', 'TimeZone', 287), Lcom_google_gwt_i18n_shared_DefaultDateTimeFormatInfo_2_classLit = createForClass('com.google.gwt.i18n.shared.', 'DefaultDateTimeFormatInfo', 284), Lcom_google_gwt_i18n_client_DefaultDateTimeFormatInfo_2_classLit = createForClass('com.google.gwt.i18n.client.', 'DefaultDateTimeFormatInfo', 283), Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr.', 'DateTimeFormatInfoImpl', 288);
$entry(onLoad)(5);
