...
defineSeed(790, 708, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ContactPresenter, Q$ContactUiHandler]), ContactPresenter_0);
...
defineSeed(791, 648, makeCastMap([Q$Receiver]), ContactPresenter$1_0);
...
defineSeed(1294, 713, makeCastMap([Q$IsWidget, Q$ContactPresenter$MyView]), ContactView_0);
...
defineSeed(1295, 1, {}, ContactView_BinderImpl_0);
...
defineSeed(1296, 1, {}, ContactView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1297, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ContactView_BinderImpl$Widgets$1_0);
...
defineSeed(1748, 643, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1749, 653, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
_.getAutoBeanFactory = function getAutoBeanFactory_6(){
  return !FACTORY_7 && (FACTORY_7 = new ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0) , FACTORY_7;
}
;
var FACTORY_7 = null;
...
defineSeed(1750, 652, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$1X_0);
...
defineSeed(1751, 581, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
...
;
var Lcom_lemania_eprospects_client_presenter_ContactPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ContactPresenter', 790), Lcom_lemania_eprospects_client_presenter_ContactPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ContactPresenter$1', 791), Lcom_lemania_eprospects_client_view_ContactView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ContactView', 1294), Lcom_lemania_eprospects_client_view_ContactView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ContactView_BinderImpl', 1295), Lcom_lemania_eprospects_client_view_ContactView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ContactView_BinderImpl$Widgets', 1296), Lcom_lemania_eprospects_client_view_ContactView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ContactView_BinderImpl$Widgets$1', 1297), Lcom_lemania_eprospects_shared_service_ContactRequestFactoryImpl_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ContactRequestFactoryImpl', 1748), Lcom_lemania_eprospects_shared_service_ContactRequestFactory_1ContactRequestContextImpl_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl', 1749), Lcom_lemania_eprospects_shared_service_ContactRequestFactory_1ContactRequestContextImpl$1X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl$1X', 1750), Lcom_lemania_eprospects_shared_service_ContactRequestFactory_1ContactRequestContextImpl_1FactoryImpl_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl_FactoryImpl', 1751);
$entry(onLoad)(9);
