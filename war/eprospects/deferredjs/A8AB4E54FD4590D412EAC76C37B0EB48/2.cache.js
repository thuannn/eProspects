...
defineSeed(778, 236, {}, ApplicationStartEvent_0);
...
defineSeed(794, 236, {}, NewApplicationNotificationEvent_0);
...
defineSeed(1114, 717, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationHomeUiHandlers]), ApplicationHomePresenter_0);
...
defineSeed(1115, 657, makeCastMap([Q$Receiver]), ApplicationHomePresenter$1_0);
...
defineSeed(1116, 657, makeCastMap([Q$Receiver]), ApplicationHomePresenter$2_0);
...
defineSeed(1117, 657, makeCastMap([Q$Receiver]), ApplicationHomePresenter$3_0);
...
defineSeed(1120, 722, makeCastMap([Q$IsWidget, Q$ApplicationHomePresenter$MyView, Q$ApplicationHomeView]), ApplicationHomeView_0);
...
defineSeed(1121, 1, {}, ApplicationHomeView_BinderImpl_0);
...
defineSeed(1122, 1, {}, ApplicationHomeView_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationHomeView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1123, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationHomeView_BinderImpl$Widgets$1_0);
...
defineSeed(1380, 731, {}, ContactPresenterMyProxyImpl$3_0);
...
defineSeed(1381, 1, {}, ContactPresenterMyProxyImpl$3$1_0);
...
defineSeed(1414, 731, {}, MainPagePresenterMyProxyImpl$6_0);
...
defineSeed(1415, 1, {}, MainPagePresenterMyProxyImpl$6$1_0);
...
defineSeed(1823, 661, makeCastMap([Q$AbstractRequest]), ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$1X_0);
...
defineSeed(1825, 661, makeCastMap([Q$AbstractRequest]), ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$7X_0);
...
;
_.val$emailAddress = null;
var Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter', 1114), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter$1', 1115), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter$2', 1116), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter$3', 1117), Lcom_lemania_eprospects_client_event_NewApplicationNotificationEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'NewApplicationNotificationEvent', 794), Lcom_lemania_eprospects_client_event_ApplicationStartEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStartEvent', 778), Lcom_lemania_eprospects_client_presenter_contact_ContactPresenterMyProxyImpl$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.contact.', 'ContactPresenterMyProxyImpl$3', 1380), Lcom_lemania_eprospects_client_presenter_contact_ContactPresenterMyProxyImpl$3$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.contact.', 'ContactPresenterMyProxyImpl$3$1', 1381), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$6', 1414), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$6$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$6$1', 1415), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView', 1120), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl', 1121), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl$Widgets', 1122), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl$Widgets$1', 1123), Lcom_lemania_eprospects_shared_applicationform_ApplicationFormRequestFactory_1ApplicationFormRequestContextImpl$1X_2_classLit = createForClass('com.lemania.eprospects.shared.applicationform.', 'ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$1X', 1823), Lcom_lemania_eprospects_shared_applicationform_ApplicationFormRequestFactory_1ApplicationFormRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.applicationform.', 'ApplicationFormRequestFactory_ApplicationFormRequestContextImpl$7X', 1825);
$entry(onLoad)(2);
