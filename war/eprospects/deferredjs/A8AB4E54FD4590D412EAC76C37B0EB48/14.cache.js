...
defineSeed(838, 717, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheAddPresenter, Q$FrmBrancheAddUiHandler]), FrmBrancheAddPresenter_0);
...
;
_.currentUser = null;
function $onSuccess_10(this$static){
...
defineSeed(839, 657, makeCastMap([Q$Receiver]), FrmBrancheAddPresenter$1_0);
_.onFailure_0 = function onFailure_10(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_10(response){
  $onSuccess_10(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
...
_.onSuccess = function onSuccess_188(){
...
function $resetForm_0(this$static){
  ...
  $setValue_1(this$static.chkBrancheActive, ($clinit_Boolean() , $clinit_Boolean() , TRUE_1));
}
...
defineSeed(1456, 722, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(1457, 10, makeCastMap([Q$Timer]), FrmBrancheAddView$1_0);
...
defineSeed(1458, 1, {}, FrmBrancheAddView_BinderImpl_0);
...
defineSeed(1459, 1, {}, FrmBrancheAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1460, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBrancheAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1848, 661, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
...
;
_.val$branche = null;
var Lcom_lemania_eprospects_client_presenter_FrmBrancheAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheAddPresenter', 838), Lcom_lemania_eprospects_client_presenter_FrmBrancheAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheAddPresenter$1', 839), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView', 1456), Lcom_lemania_eprospects_client_view_FrmBrancheAddView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView$1', 1457), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl', 1458), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets', 1459), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets$1', 1460), Lcom_lemania_eprospects_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$4X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$4X', 1848);
$entry(onLoad)(14);
