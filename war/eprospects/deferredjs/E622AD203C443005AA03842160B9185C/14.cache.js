...
defineSeed(1317, 702, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(1697, 641, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
...
;
_.val$branche = null;
var Lcom_lemania_eprospects_client_presenter_FrmBrancheAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheAddPresenter', 818), Lcom_lemania_eprospects_client_presenter_FrmBrancheAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBrancheAddPresenter$1', 819), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView', 1317), Lcom_lemania_eprospects_client_view_FrmBrancheAddView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView$1', 1318), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl', 1319), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets', 1320), Lcom_lemania_eprospects_client_view_FrmBrancheAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets$1', 1321), Lcom_lemania_eprospects_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$4X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$4X', 1697);
$entry(onLoad)(14);
