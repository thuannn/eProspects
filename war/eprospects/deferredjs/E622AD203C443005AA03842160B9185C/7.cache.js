...
defineSeed(757, 233, {}, ApplicationStep4CompletedEvent_0);
...
defineSeed(1166, 697, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationStep4Presenter, Q$ApplicationStep4UiHandlers]), ApplicationStep4Presenter_0);
...
defineSeed(1169, 702, makeCastMap([Q$IsWidget, Q$ApplicationStep4Presenter$MyView]), ApplicationStep4View_0);
...
defineSeed(1170, 1, {}, ApplicationStep4View_BinderImpl_0);
...
defineSeed(1171, 1, {}, ApplicationStep4View_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationStep4View_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1172, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$1_0);
...
defineSeed(1173, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationStep4View_BinderImpl$Widgets$2_0);
...
defineSeed(1256, 710, {}, MainPagePresenterMyProxyImpl$12_0);
_.success = function success_48(presenter){
  $success_46(dynamicCast(presenter, Q$MainPagePresenter));
}
;
function MainPagePresenterMyProxyImpl$12$1_0(){
}

defineSeed(1257, 1, {}, MainPagePresenterMyProxyImpl$12$1_0);
_.execute_0 = function execute_73(){
  $clinit_History();
  !!impl_2 && $newItem(impl_2, 'applicationstep5', true);
}
;
var Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4Presenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4Presenter', 1166), Lcom_lemania_eprospects_client_event_ApplicationStep4CompletedEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStep4CompletedEvent', 757), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$12_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$12', 1256), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$12$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$12$1', 1257), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View', 1169), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl', 1170), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets', 1171), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$1', 1172), Lcom_lemania_eprospects_client_presenter_applicationstep4_ApplicationStep4View_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationstep4.', 'ApplicationStep4View_BinderImpl$Widgets$2', 1173);
$entry(onLoad)(7);
