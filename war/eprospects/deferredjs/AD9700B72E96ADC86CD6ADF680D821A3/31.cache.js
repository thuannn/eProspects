...
defineSeed(1023, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1024, 635, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1025, 635, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1026, 635, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1027, 635, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1028, 635, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1029, 635, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1030, 635, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1031, 635, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1032, 635, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1524, 701, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1525, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1526, 362, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1527, 1, {}, ProfsView$3_0);
...
defineSeed(1528, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), ProfsView$4_0);
...
defineSeed(1529, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1530, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1531, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1532, 362, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1533, 1, {}, ProfsView$9_0);
...
defineSeed(1534, 1, {}, ProfsView_BinderImpl_0);
...
defineSeed(1535, 1, {}, ProfsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1536, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$1_0);
...
defineSeed(1537, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$2_0);
...
defineSeed(1538, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$3_0);
...
defineSeed(1539, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$4_0);
...
defineSeed(1590, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
_.setActive = function setActive(active){
  dynamicCast($getWrapped(this.this$0), Q$AssignmentProxy).setActive(active);
}
;
defineSeed(1591, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
...
defineSeed(1648, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1649, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1650, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1740, 639, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
...
;
_.val$newProf = null;
var Lcom_lemania_eprospects_client_presenter_ProfsPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter', 1023), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$1', 1024), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$2', 1026), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$3', 1027), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$5', 1028), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$6', 1029), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$7', 1030), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$8', 1031), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$9', 1032), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$10', 1025), Lcom_lemania_eprospects_client_view_ProfsView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView', 1524), Lcom_lemania_eprospects_client_view_ProfsView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$1', 1525), Lcom_lemania_eprospects_client_view_ProfsView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$2', 1526), Lcom_lemania_eprospects_client_view_ProfsView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$3', 1527), Lcom_lemania_eprospects_client_view_ProfsView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$4', 1528), Lcom_lemania_eprospects_client_view_ProfsView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$5', 1529), Lcom_lemania_eprospects_client_view_ProfsView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$6', 1530), Lcom_lemania_eprospects_client_view_ProfsView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$7', 1531), Lcom_lemania_eprospects_client_view_ProfsView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$8', 1532), Lcom_lemania_eprospects_client_view_ProfsView$9_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$9', 1533), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl', 1534), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets', 1535), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$1', 1536), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$2', 1537), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$3', 1538), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$4', 1539), Lcom_lemania_eprospects_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$6X', 1740), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$3X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$3X', 1650), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$10X', 1648), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$11X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$11X', 1649);
$entry(onLoad)(31);
