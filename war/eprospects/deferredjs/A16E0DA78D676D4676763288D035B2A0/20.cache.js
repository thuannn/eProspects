function $addNewClasse(this$static, className, coursId, isActif){
  ...
  if (!className.length) {
    alert_0(($clinit_NotificationTypes() , 'Missing input : ') + ' - Nom de la classe');
    return;
  }
  if (!coursId.length) {
    alert_0(($clinit_NotificationTypes() , 'Missing input : ') + ' - Merci de choisir un programme');
    return;
  }
...
function $onEcoleSelected_1(this$static, ecoleId){
  ...
  $fire($listAll_4(rc, ecoleId), new FrmClasseAddPresenter$3_0(this$static));
}
...
defineSeed(913, 715, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
_.onReset = function onReset_10(){
  ...
  $fire($listAll_5(rc), new FrmClasseAddPresenter$1_0(this));
}
;
...
defineSeed(914, 655, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
;
_.this$0 = null;
function $onSuccess_48(this$static){
...
defineSeed(915, 655, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
_.onFailure_0 = function onFailure_50(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_50(response){
  $onSuccess_48(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
...
defineSeed(916, 655, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1531, 720, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1532, 10, makeCastMap([Q$Timer]), FrmClasseAddView$1_0);
...
defineSeed(1533, 1, {}, FrmClasseAddView_BinderImpl_0);
...
defineSeed(1534, 1, {}, FrmClasseAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1535, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmClasseAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1536, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmClasseAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1883, 659, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_eprospects_client_presenter_FrmClasseAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmClasseAddPresenter', 913), Lcom_lemania_eprospects_client_presenter_FrmClasseAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmClasseAddPresenter$1', 914), Lcom_lemania_eprospects_client_presenter_FrmClasseAddPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmClasseAddPresenter$2', 915), Lcom_lemania_eprospects_client_presenter_FrmClasseAddPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmClasseAddPresenter$3', 916), Lcom_lemania_eprospects_client_view_FrmClasseAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmClasseAddView', 1531), Lcom_lemania_eprospects_client_view_FrmClasseAddView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmClasseAddView$1', 1532), Lcom_lemania_eprospects_client_view_FrmClasseAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmClasseAddView_BinderImpl', 1533), Lcom_lemania_eprospects_client_view_FrmClasseAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmClasseAddView_BinderImpl$Widgets', 1534), Lcom_lemania_eprospects_client_view_FrmClasseAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmClasseAddView_BinderImpl$Widgets$1', 1535), Lcom_lemania_eprospects_client_view_FrmClasseAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmClasseAddView_BinderImpl$Widgets$2', 1536), Lcom_lemania_eprospects_shared_service_ClasseRequestFactory_1ClasseRequestContextImpl$8X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ClasseRequestFactory_ClasseRequestContextImpl$8X', 1883);
$entry(onLoad)(20);
