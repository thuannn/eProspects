...
defineSeed(986, 708, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmSubjectAddPresenter, Q$FrmSubjectAddUiHandler]), FrmSubjectAddPresenter_0);
...
defineSeed(987, 648, makeCastMap([Q$Receiver]), FrmSubjectAddPresenter$1_0);
...
defineSeed(1496, 713, makeCastMap([Q$IsWidget, Q$FrmSubjectAddPresenter$MyView]), FrmSubjectAddView_0);
...
defineSeed(1497, 10, makeCastMap([Q$Timer]), FrmSubjectAddView$1_0);
...
defineSeed(1498, 1, {}, FrmSubjectAddView_BinderImpl_0);
...
defineSeed(1499, 1, {}, FrmSubjectAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1500, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmSubjectAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1808, 652, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$6X_0);
...
;
_.val$subject = null;
var Lcom_lemania_eprospects_client_presenter_FrmSubjectAddPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmSubjectAddPresenter', 986), Lcom_lemania_eprospects_client_presenter_FrmSubjectAddPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmSubjectAddPresenter$1', 987), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView', 1496), Lcom_lemania_eprospects_client_view_FrmSubjectAddView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView$1', 1497), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl', 1498), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets', 1499), Lcom_lemania_eprospects_client_view_FrmSubjectAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets$1', 1500), Lcom_lemania_eprospects_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$6X', 1808);
$entry(onLoad)(27);
