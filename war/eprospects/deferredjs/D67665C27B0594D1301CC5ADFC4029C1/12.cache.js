...
defineSeed(766, 235, {}, EcoleAddedEvent_0);
...
defineSeed(804, 699, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$EcoleAddPresenter, Q$EcoleAddUiHandler]), EcoleAddPresenter_0);
...
defineSeed(805, 638, makeCastMap([Q$Receiver]), EcoleAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(813, 730, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$EcoleAddedEvent$EcoleAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(814, 712, {}, EcolePresenterMyProxyImpl$1_0);
...
defineSeed(815, 1, {}, EcolePresenterMyProxyImpl$1$1_0);
...
defineSeed(1283, 704, makeCastMap([Q$IsWidget, Q$EcoleAddPresenter$MyView]), EcoleAddView_0);
...
defineSeed(1720, 642, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$5X_0);
