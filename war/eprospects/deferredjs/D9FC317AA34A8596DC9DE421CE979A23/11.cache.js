...
defineSeed(786, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(787, 631, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(788, 631, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(789, 631, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(790, 631, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1261, 697, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1262, 359, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1263, 1, {}, CoursView$2_0);
...
defineSeed(1264, 359, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1265, 1, {}, CoursView$4_0);
...
defineSeed(1266, 1, {}, CoursView_BinderImpl_0);
...
defineSeed(1267, 1, {}, CoursView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1268, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), CoursView_BinderImpl$Widgets$1_0);
...
defineSeed(1702, 635, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
...
;
_.val$newCours = null;
var Lcom_lemania_eprospects_client_presenter_CoursPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter', 786), Lcom_lemania_eprospects_client_presenter_CoursPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$1', 787), Lcom_lemania_eprospects_client_presenter_CoursPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$2', 788), Lcom_lemania_eprospects_client_presenter_CoursPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$3', 789), Lcom_lemania_eprospects_client_presenter_CoursPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'CoursPresenter$4', 790), Lcom_lemania_eprospects_client_view_CoursView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView', 1261), Lcom_lemania_eprospects_client_view_CoursView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$1', 1262), Lcom_lemania_eprospects_client_view_CoursView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$2', 1263), Lcom_lemania_eprospects_client_view_CoursView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$3', 1264), Lcom_lemania_eprospects_client_view_CoursView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView$4', 1265), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl', 1266), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl$Widgets', 1267), Lcom_lemania_eprospects_client_view_CoursView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'CoursView_BinderImpl$Widgets$1', 1268), Lcom_lemania_eprospects_shared_service_CoursRequestFactory_1CoursRequestContextImpl$8X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$8X', 1702);
$entry(onLoad)(11);
