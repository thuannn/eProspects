...
defineSeed(1019, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1020, 631, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1021, 631, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1022, 631, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1023, 631, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1024, 631, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1025, 631, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1026, 631, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1027, 631, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1028, 631, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1520, 697, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1521, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1522, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1523, 1, {}, ProfsView$3_0);
...
defineSeed(1524, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), ProfsView$4_0);
...
defineSeed(1525, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1526, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1527, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1528, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1529, 1, {}, ProfsView$9_0);
...
defineSeed(1530, 1, {}, ProfsView_BinderImpl_0);
...
defineSeed(1531, 1, {}, ProfsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1532, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$1_0);
...
defineSeed(1533, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$2_0);
...
defineSeed(1534, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$3_0);
...
defineSeed(1535, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$4_0);
...
defineSeed(1586, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
_.setActive = function setActive(active){
  dynamicCast($getWrapped(this.this$0), Q$AssignmentProxy).setActive(active);
}
;
defineSeed(1587, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
...
defineSeed(1644, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1645, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1646, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1736, 635, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
...
;
_.val$newProf = null;
var Lcom_lemania_eprospects_client_presenter_ProfsPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter', 1019), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$1', 1020), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$2', 1022), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$3', 1023), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$5', 1024), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$6', 1025), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$7', 1026), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$8', 1027), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$9', 1028), Lcom_lemania_eprospects_client_presenter_ProfsPresenter$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'ProfsPresenter$10', 1021), Lcom_lemania_eprospects_client_view_ProfsView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView', 1520), Lcom_lemania_eprospects_client_view_ProfsView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$1', 1521), Lcom_lemania_eprospects_client_view_ProfsView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$2', 1522), Lcom_lemania_eprospects_client_view_ProfsView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$3', 1523), Lcom_lemania_eprospects_client_view_ProfsView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$4', 1524), Lcom_lemania_eprospects_client_view_ProfsView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$5', 1525), Lcom_lemania_eprospects_client_view_ProfsView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$6', 1526), Lcom_lemania_eprospects_client_view_ProfsView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$7', 1527), Lcom_lemania_eprospects_client_view_ProfsView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$8', 1528), Lcom_lemania_eprospects_client_view_ProfsView$9_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView$9', 1529), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl', 1530), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets', 1531), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$1', 1532), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$2', 1533), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$3', 1534), Lcom_lemania_eprospects_client_view_ProfsView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'ProfsView_BinderImpl$Widgets$4', 1535), Lcom_lemania_eprospects_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$6X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$6X', 1736), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$3X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$3X', 1646), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$10X', 1644), Lcom_lemania_eprospects_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$11X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$11X', 1645);
$entry(onLoad)(31);
