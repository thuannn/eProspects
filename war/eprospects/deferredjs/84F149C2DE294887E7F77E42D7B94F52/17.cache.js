...
function $onBulletinSelected(this$static, bulletin){
  ...
  $initialize_0(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl_0(rf);
  $fire($listAll_2(rc, '' + toString_7(bulletin.getId_0().value_0)), new FrmBulletinManagementPresenter$7_0(this$static, bulletin));
}
...
function $onSubjectSelected(this$static, subject){
  ...
  $initialize_0(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl_0(rf);
  $fire($listAll_1(rc, '' + toString_7(subject.getId_0().value_0)), new FrmBulletinManagementPresenter$9_0(this$static));
}
...
_.onReset = function onReset_8(){
  ...
  $fire($listAll_4(rc), new FrmBulletinManagementPresenter$3_0(this));
  ...
  $fire($listAll_0(rc_0), new FrmBulletinManagementPresenter$1_0(this));
}
;
...
defineSeed(868, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$1_0);
...
defineSeed(869, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$10_0);
_.onFailure_0 = function onFailure_25(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_25(response){
  $onSuccess_24(this, dynamicCast(response, Q$BulletinBrancheProxy));
}
;
_.this$0 = null;
function $onSuccess_25(this$static){
...
defineSeed(870, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$11_0);
_.onFailure_0 = function onFailure_26(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_26(response){
  $onSuccess_25(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
...
defineSeed(871, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$12_0);
...
defineSeed(872, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$13_0);
_.onFailure_0 = function onFailure_28(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_28(response){
  $onSuccess_27(this, dynamicCast(response, Q$BulletinSubjectProxy));
}
;
_.this$0 = null;
...
defineSeed(873, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$14_0);
_.onFailure_0 = function onFailure_29(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_29(response){
  $onSuccess_28(this, dynamicCast(response, Q$BulletinBrancheProxy));
}
;
_.this$0 = null;
...
defineSeed(875, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$16_0);
...
defineSeed(876, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$2_0);
...
defineSeed(877, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$3_0);
...
defineSeed(878, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$4_0);
...
defineSeed(879, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$5_0);
...
defineSeed(880, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$6_0);
...
defineSeed(881, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$7_0);
...
defineSeed(882, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$8_0);
_.onFailure_0 = function onFailure_38(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_38(response){
  $onSuccess_36(this, dynamicCast(response, Q$Boolean));
}
;
_.this$0 = null;
...
defineSeed(883, 655, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$9_0);
...
defineSeed(1245, 1, makeCastMap([Q$RunAsyncCallback]));
_.onSuccess = function onSuccess_173(){
...
function $onCmdAddBrancheClick(this$static){
  !!this$static.uiHandlers && $addBranche(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), '' + toString_7(this$static.selectedSubject.getId_0().value_0), $getValue_1(this$static.lstBranches, this$static.lstBranches.element.selectedIndex), $getPropertyString(this$static.txtBrancheCoef.element, 'value'));
}

function $onCmdAddSubjectClick(this$static){
  !!this$static.uiHandlers && $addSubject(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), '' + toString_7(this$static.selectedBulletin.getId_0().value_0), $getValue_1(this$static.lstSubjects, this$static.lstSubjects.element.selectedIndex), $getValue_1(this$static.lstProfessors, this$static.lstProfessors.element.selectedIndex), $getPropertyString(this$static.txtSubjectCoef.element, 'value'));
}
...
function $onLstClassesChange_0(this$static){
  ...
  !!this$static.uiHandlers && $onClassChange(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstClasses, this$static.lstClasses.element.selectedIndex));
}
...
function $onLstEcolesChange_0(this$static){
  ...
  !!this$static.uiHandlers && $onEcoleSelected_0(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstEcoles, this$static.lstEcoles.element.selectedIndex));
}
...
function $onLstProgrammesChange_0(this$static){
  ...
  if (!$getValue_1(this$static.lstProgrammes, this$static.lstProgrammes.element.selectedIndex).length)
    return;
  !!this$static.uiHandlers && $onProgrammeSelected_0(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstProgrammes, this$static.lstProgrammes.element.selectedIndex));
}

function $onLstSubjectsChange(this$static){
  !!this$static.uiHandlers && $loadProfessorList(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstSubjects, this$static.lstSubjects.element.selectedIndex), $getValue_1(this$static.lstClasses, this$static.lstClasses.element.selectedIndex));
}
...
defineSeed(1349, 720, makeCastMap([Q$IsWidget, Q$FrmBulletinManagementPresenter$MyView]), FrmBulletinManagementView_0);
...
defineSeed(1350, 401, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$1_0);
...
defineSeed(1351, 401, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$10_0);
_.getValue = function getValue_17(object){
  return $getValue_4(dynamicCast(object, Q$BulletinSubjectProxy));
}
;
...
defineSeed(1352, 375, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$11_0);
...
defineSeed(1353, 1, {}, FrmBulletinManagementView$12_0);
...
defineSeed(1354, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$13_0);
...
defineSeed(1355, 401, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$14_0);
...
defineSeed(1356, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$15_0);
...
defineSeed(1357, 375, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$2_0);
_.getValue = function getValue_20(object){
  return $getValue_5(dynamicCast(object, Q$BulletinBrancheProxy));
}
;
...
defineSeed(1358, 1, {}, FrmBulletinManagementView$3_0);
...
defineSeed(1359, 375, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$4_0);
...
defineSeed(1360, 1, {}, FrmBulletinManagementView$5_0);
...
defineSeed(1361, 401, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$6_0);
...
defineSeed(1362, 375, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$7_0);
...
defineSeed(1363, 1, {}, FrmBulletinManagementView$8_0);
...
defineSeed(1364, 401, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$9_0);
...
defineSeed(1365, 1, {}, FrmBulletinManagementView_BinderImpl_0);
...
defineSeed(1366, 1, {}, FrmBulletinManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1367, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1368, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1369, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$3_0);
...
defineSeed(1370, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$4_0);
...
defineSeed(1371, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$5_0);
...
defineSeed(1372, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$6_0);
...
defineSeed(1622, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1623, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
_.setBrancheCoef = function setBrancheCoef_0(brancheCoef){
  $setProperty(this.this$0, 'brancheCoef', brancheCoef);
}
;
defineSeed(1628, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
;
defineSeed(1629, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
defineSeed(1688, 659, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0);
...
defineSeed(1692, 659, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0);
...
defineSeed(1709, 659, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0);
...
defineSeed(1712, 659, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0);
...
defineSeed(1804, 659, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$4X_0);
...
;
_.val$bulletin = null;
var Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter', 867), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$1', 868), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$2', 876), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$3', 877), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$4_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$4', 878), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$5_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$5', 879), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$6', 880), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$7_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$7', 881), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$8_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$8', 882), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$9_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$9', 883), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$10', 869), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$11_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$11', 870), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$12_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$12', 871), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$13_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$13', 872), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$14_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$14', 873), Lcom_lemania_eprospects_client_presenter_FrmBulletinManagementPresenter$16_2_classLit = createForClass('com.lemania.eprospects.client.presenter.', 'FrmBulletinManagementPresenter$16', 875), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView', 1349), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$1', 1350), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$2', 1357), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$3', 1358), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$4', 1359), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$5', 1360), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$6', 1361), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$7_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$7', 1362), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$8_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$8', 1363), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$9_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$9', 1364), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$10_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$10', 1351), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$11_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$11', 1352), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$12_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$12', 1353), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$13_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$13', 1354), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$14_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$14', 1355), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView$15_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView$15', 1356), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl', 1365), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets', 1366), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$1', 1367), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$2', 1368), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$3', 1369), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$4', 1370), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$5', 1371), Lcom_lemania_eprospects_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.eprospects.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$6', 1372), Lcom_lemania_eprospects_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$4X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$4X', 1804), Lcom_lemania_eprospects_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X', 1712), Lcom_lemania_eprospects_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X', 1709), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$7X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X', 1692), Lcom_lemania_eprospects_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$10X_2_classLit = createForClass('com.lemania.eprospects.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X', 1688);
$entry(onLoad)(17);
