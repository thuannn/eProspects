...
defineSeed(1120, 715, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ApplicationPaymentPresenter, Q$ApplicationPaymentUiHandlers]), ApplicationPaymentPresenter_0);
...
defineSeed(1123, 720, makeCastMap([Q$IsWidget, Q$ApplicationPaymentPresenter$MyView, Q$ApplicationPaymentView]), ApplicationPaymentView_0);
...
defineSeed(1124, 1, {}, ApplicationPaymentView_BinderImpl_0);
...
defineSeed(1125, 1, {}, ApplicationPaymentView_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationPaymentView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1126, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationPaymentView_BinderImpl$Widgets$1_0);
...
defineSeed(1127, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationPaymentView_BinderImpl$Widgets$2_0);
...
defineSeed(1128, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationPaymentView_BinderImpl$Widgets$3_0);
...
defineSeed(1132, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1251, 728, {}, MainPagePresenterMyProxyImpl$10_0);
...
defineSeed(1252, 1, {}, MainPagePresenterMyProxyImpl$10$1_0);
_.execute_0 = function execute_72(){
  $clinit_History();
  !!impl_2 && $newItem(impl_2, 'applicationfinal', true);
}
;
var Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentPresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentPresenter', 1120), Lcom_lemania_eprospects_client_event_ApplicationPaymentEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationPaymentEvent', 770), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$10_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$10', 1251), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$10$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$10$1', 1252), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView', 1123), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl', 1124), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets', 1125), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets$1', 1126), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets$2', 1127), Lcom_lemania_eprospects_client_presenter_applicationpayment_ApplicationPaymentView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationpayment.', 'ApplicationPaymentView_BinderImpl$Widgets$3', 1128);
$entry(onLoad)(3);
