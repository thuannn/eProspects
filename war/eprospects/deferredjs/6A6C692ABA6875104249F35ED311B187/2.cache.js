...
defineSeed(1105, 711, makeCastMap([Q$IsWidget, Q$ApplicationHomePresenter$MyView, Q$ApplicationHomeView]), ApplicationHomeView_0);
...
defineSeed(1106, 1, {}, ApplicationHomeView_BinderImpl_0);
...
defineSeed(1107, 1, {}, ApplicationHomeView_BinderImpl$Widgets_0);
_.owner = null;
function ApplicationHomeView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1108, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ApplicationHomeView_BinderImpl$Widgets$1_0);
...
defineSeed(1268, 719, {}, MainPagePresenterMyProxyImpl$6_0);
...
defineSeed(1269, 1, {}, MainPagePresenterMyProxyImpl$6$1_0);
_.execute_0 = function execute_80(){
  $clinit_History();
  !!impl_2 && $newItem(impl_2, 'applicationstep1', true);
}
;
var Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomePresenter_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomePresenter', 1102), Lcom_lemania_eprospects_client_event_ApplicationStartEvent_2_classLit = createForClass('com.lemania.eprospects.client.event.', 'ApplicationStartEvent', 762), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$6_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$6', 1268), Lcom_lemania_eprospects_client_presenter_mainpage_MainPagePresenterMyProxyImpl$6$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.mainpage.', 'MainPagePresenterMyProxyImpl$6$1', 1269), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView', 1105), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl', 1106), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl$Widgets', 1107), Lcom_lemania_eprospects_client_presenter_applicationhome_ApplicationHomeView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.eprospects.client.presenter.applicationhome.', 'ApplicationHomeView_BinderImpl$Widgets$1', 1108);
$entry(onLoad)(2);
