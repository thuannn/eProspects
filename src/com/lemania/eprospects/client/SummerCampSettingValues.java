...
public class SummerCampSettingValues {
	//
	public static String applicationName = "Lémania Camp & Cours d'été";
	...
	//
	public static String programme_name_summercamp = "LEMANIA CAMP D'ETE AVEC INTERNAT";
	public static String programme_code_summercamp = "SUMMERCAMP";
	//
	public static String programme_name_summercourse = "LEMANIA COURS D'ETE SANS INTERNAT";
	public static String programme_code_summercourse = "SUMMERCOURSE";
	//
	public static String course_name_noconversation = "Cours de langue";
	public static String course_code_noconversation = "LANGUE";
	//
	public static String course_name_withconversation = "Cours de langue & Cours de conversation";
	public static String course_code_withconversation = "LANGUECONVERSATION";
	
	//
	public static String sexe_male_description = "Garçon";
	public static String sexe_male_code = "MALE";
	public static String sexe_female_description = "Fille";
	public static String sexe_female_code = "FEMALE";
	
	//
	public static String airport_direction_from_description = "Depuis";
